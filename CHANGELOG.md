...
- **cmd/podinfo/commands/server:** parse redis info with flags ([8e57115][2])
- **api/handlers/cache:** register **DELETE** `/cache/{key}` route in API group
  `Register()` ([a5ab3a8][3])
- **api/handlers/cache:** register **DELETE** `/cache/{key}` route in API group
  `Register()` ([d12f7db][4])
- **api/handlers/cache/delete:** `handler` implementation ([07c94d5][5])

### Documentation

- added code stats ([3e0e1ef][6])
- **api/handlers/cache/delete:** package synopsis ([d0e25cb][7])
- **changelog:** v0.7.0 ([8b5e5d2][8])
...
- **api/handlers/cache:** register **GET** `/cache/{key}` route in API group
  `Register()` ([ab70334][10])
- **api/handlers/cache/get:** route `register` implementation ([9935643][11])
- **api/handlers/cache/get:** `handler` implementation ([f154df8][12])

#### Documentation

- **api/handlers/cache/doc:** package synopsis ([9de9d35][13])
- **changelog:** v0.7.0 ([61739b5][14])

### [v0.6.2][15] (2023-02-15)

#### Features

- **api/handlers/cache:** register **PUT** `/cache/{key}` route in API group
  `Register()` ([b7cb2ba][16])
- **api/handlers/cache/put:** route `register` implementation ([6696e26][17])
- **api/handlers/cache/put:** `handler` implementation ([15a177c][18])

#### Documentation

- **api/handlers/cache/put:** package synopsis ([26257c2][19])
- **changelog:** v0.7.0 ([1b6e7f1][20])

### [v0.6.1][21] (2023-02-15)

#### Features

- **api/handlers/cache:** register **POST** `/cache/{key}` route in API group
  `Register()` ([f2f2164][22])
- **api/handlers/cache/post:** route `register` implementation ([fb15f04][23])
- **api/handlers/cache/post:** `handler` implementation ([86f9e9d][24])

#### Documentation

- **api/handlers/cache:** package synopsis ([1e8dc7e][25])
- **api/handlers/cache/post:** package synopsis ([f878c09][26])
- **changelog:** v0.6.0 ([cf372a5][27])

## [v0.6.0][28] (2023-02-15)

### Features

- **api/handlers/cache/shared:** `preflight` request handler ([489db81][29])
- **api/handlers/cache/shared:** `API group` shared constructs ([47b687d][30])
- **cmd/podinfo/commands/server:** flags to read `redis` config ([76a07eb][31])
- **api/core:** add `redis` configuration fields and methods ([cc54fcf][32])
- **internal/cli/value:** handle `int` type cli flags ([d26c406][33])

### Documentation

- **api/handlers/cache/shared:** package synopsis ([2732306][34])
- **changelog:** v0.5.0 ([c313777][35])
...
- **docker/podinfo:** minor changes to build script ([9e7f04a][38])

### Chore

- **re-commit:** hook updates ([bff048a][39])

## [v0.5.0][40] (2023-02-15)

### [v0.4.1][41] (2023-02-15)

#### Features

- **api/handlers:** register **GET** `/delay/{seconds}` route in `Initialize()`
  ([5a9dc8e][42])
- **api/handlers/delay:** route `register` implementation ([f39830b][43])
- **api/handlers/delay:** `handler` implementation ([bf469a3][44])
- **api/handlers/delay:** `response` setup ([d22dc78][45])

#### Documentation

- **changelog:** v0.5.0 ([c313777][35])
- **api/handlers/delay:** package synopsis ([e260245][46])
- **changelog:** v0.4.0 ([d7d5af7][47])

#### Build System

- **build/just/podinfo:** `delay-probe` recipe ([9d0b55f][48])

## [v0.4.0][49] (2023-02-15)

### Features

- **api/handlers:** register `/headers` route in `Initialize()` ([10cef5d][50])
- **api/handlers/headers:** route `register` implementation ([989f948][51])
- **api/handlers/headers:** `handler` implementation ([9871e64][52])
- **api/handlers/headers:** `response` type ([019355e][53])

### Documentation

- **api/handlers/headers:** package synopsis ([489218a][54])

### Build System

- **build/just/podinfo:** `headers-probe` recipe ([239a061][55])

## [v0.3.0][56] (2023-02-15)

### Features

- **api/handlers:** register `/env` route in `Initialize()` ([2d98b6a][57])
- **api/handlers/env:** routte `register` implementation ([958bc47][58])
- **api/handlers/env:** `handler` implementation ([0ef5a8f][59])
- **api/handlers/env:** `response` type ([877b7e4][60])

### Documentation

- **api/handlers/env:** package synopsis ([edc489e][61])

### Build System

- **build/just/podinfo:** `env-probe` recipe ([b66f28b][62])

### [v0.2.2][63] (2023-02-15)

#### Features

- **api/handlers:** register `/readyz/enable` route in `Initialize()`
  ([dead392][64])
- **api/handlers/readiness/enable:** route init ([b56a400][65])
- **api/handlers/readiness/enable:** handler setup ([9356de0][66])

#### Documentation

- **api/handlers/readiness/enable:** package synopsis ([faeaf50][67])

#### Build System

- **build/just/podinfo:** `readiness-probe-enable` recipe ([65c6272][68])

### [v0.2.1][69] (2023-02-15)

#### Features

- **api/handlers:** register the route in `Initialize()` ([ae99b84][70])
...
- **api/handlers/readiness/disable:** `HandlerFn` synopsis ([ac1c0ee][78])
- **api/handlers/readiness/disable:** `handler` struct synopsis ([5e8ae1e][79])
- **api/handlers/readiness/disable:** package synopsis ([4753ee2][80])
- **changelog:** v0.2.0 ([2ec37fc][81])

#### Build System

- **build/just/podinfo:** `readiness-probe-disable` recipe ([f0efeb5][82])

## [v0.2.0][83] (2023-02-15)

### Features

- **api/handlers/readiness:** `handler.Register()` implementation
  ([229f6ef][84])
- **api/handlers/readiness:** `init()` implementation ([316c88d][85])
- **api/handlers/readiness:** `HandlerFn` implementation ([fa4e4e0][86])
- **api/handlers/readiness:** `handler.GetStatus()` implementation
  ([6975ceb][87])
- **api/handlers/readiness:** `handler.SetStatus()` implementation
  ([0ae4c75][88])
- **api/handlers/readiness:** `handler.GetLogger()` synopsis ([1fb4903][89])
- **api/handlers/readiness:** `handler.GetLogger()` implementation
  ([2af2f25][90])
- **api/handlers/readiness:** `handler.SetLogger()` implementation
  ([a34f22d][91])
- **api/handlers/readiness:** `handler` struct implementation ([4a73558][92])
- **api/handlers/readiness:** `Response` struct implementation ([8ea8855][93])
- **api/handlers/readiness:** `Status.String()` implementation ([f81e205][94])
- **api/handlers/readiness:** `Status` enum ([c45a277][95])
- **sdk/api/response:** `LogEntry()` implementation ([c62180d][96])

### Documentation

- **build/just/podinfo:** `readiness-probe` recipe ([a989ce1][97])
- **api/handlers/readiness:** `HandlerFn` synopsis ([5b226c3][98])
- **api/handlers/readiness:** `handler.GetStatus()` synopsis ([7f85163][99])
- **api/handlers/readiness:** `handler.SetStatus()` synopsis ([db54578][100])
- **api/handlers/readiness:** `handler.SetLogger()` synopsis ([2ac7d67][101])
- **api/handlers/readiness:** `handler` struct synopsis ([14fcb57][102])
- **api/handlers/readiness:** `Response` struct synopsis ([7c7ecff][103])
- **api/handlers/readiness:** `Status.String()` synopsis ([777320c][104])
- **api/handlers/readiness:** `Status` enum ([9788dfb][105])
- **api/handlers/readiness:** package synopsis ([92c17f3][106])
- **sdk/api/response:** `LogEntry()` synopsis ([c9c5f7d][107])
- **changelog:** v0.2.0 ([c46195b][108])

### Refactors

- **api/handlers/liveness:** new pattern of writing `HandlerFn`
  ([d270881][109])
- **sdk/api/response:** `Write` function ([66fd066][110])
- **api/handlers/liveness:** change route impl pattern ([6efbf25][111])

### Build System

- **build/just/podinfo:** `readiness-probe` recipe ([14a6fe0][112])

### Chore

- **gitpod:** fix `gitpod` shell config in dockerfile ([ad05fc9][113])

### [v0.1.1][114] (2023-02-13)

#### Documentation

- **changelog:** `v0.1.0` ([e1bdb33][115])

#### Build System

- **just/git:** prune refs in `git-fetch` recipe ([69d5e05][116])

## [v0.1.0][117] (2023-02-13)

### Features

- **sdk/api/response:** `WriteJSON()` function implementation ([ac8c96c][118])
- **sdk/api/response:** `WriteSuccessfulJSONRaw()` function implementation
  ([f264be1][119])
- **api/handlers:** remove `Prefix` from pre-flight handler ([ae48e9d][120])
- **api/handlers:** Register and initialize `kubernetes-liveness-probe` route
  ([1c416f5][121])
- **api/handlers/liveness:** `Initialize()` function ([73548a0][122])
- **api/handlers/liveness:** `New()` function ([016f07c][123])
- **api/handlers/liveness:** `Handler` struct ([133a5a8][124])
- **api/handlers/liveness:** package constants ([a0b8f71][125])
- **api/handlers/liveness:** `Response` struct ([9bc1341][126])

### Bug Fixes

- **sdk/api/response:** address linter complaints ([a9eed4e][127])

### Documentation

- **docker/buildx:** `gitpod` target ([11b8055][128])
- `liveness-probe` instruction ([fc5852c][129])
- **sdk/api/response:** `WriteJSON()` function synopsis ([7e25e0a][130])
- **sdk/api/response:** `WriteSuccessfulJSONRaw()` synopsis ([63d16c4][131])
- **swaggger:** add `GET` verb for `/healthz` ([5a0bb54][132])
- fix instruction to run mage's `build` target ([d35f513][133])
- **api/handlers/liveness:** `Initialize()` function ([a8993b7][134])
- **api/handlers/liveness:** `New()` function ([add5240][135])
- **api/handlers/liveness:** `Handler` struct ([06f7e41][136])
- **api/handlers/liveness:** package constants ([0e5f809][137])
- **api/handlers/liveness:** `Status` enum ([2ac0c5e][138])
- **api/handlers/liveness:** package synopsis ([efe22ac][139])
- **changelog:** updated changelog for v0.0.1 ([533f465][140])

### Refactors

- **api/handlers/liveness:** update `handler()` to write response json without
  adding additional fields ([985c2cf][141])
...
- **go-releaser:** do not sign archive ([b931100][144])
- **docker:** `gitpod` target ([006af3c][145])
- **just/bootstrap:** add `rust` toolchain ([6d9e725][146])
- **docker:** laxer package versioning in dockerfile ([9db2bb8][147])
- **docker:** fixed minor issues with `docker-bake.hcl` file ([747b4f4][148])
- **just/bootstrap:** add `bootstrap-os-pkgs` dependency to `bootstrap` target
  ([c397414][149])
- **just/go:** fix `mage` install in `_build-go` target ([7a6a5d9][150])
- **just/commit:** fix `bootstrap-pre-commit` hook installation
  ([495f420][151])
- **just/semver:** changed changelog commit message pattern ([9a5964e][152])

### CI

- **docker:** detect `TAG` ([5ca9bde][153])
- **go:** add `go-releaser` step ([74090a2][154])
- **release:** fix deprecated flags in `go-releaser` step ([0c641be][155])
- update min go version to `1.20` ([385d829][156])
- **go:** fixed arguments in `test` step ([2e45224][157])
- **go:** fixed arguments in `build` step ([55e6ae7][158])
- **release:** remove `unshallow` step ([2011e4f][159])
- **release:** update `setup-go` and `goreleaser-action` actions
  ([ea4cc92][160])

### Chore

- **gitpod:** source `gitpod` variables ([168e63f][161])
- **gitpod:** `rust` toolchain configuration ([e3e3d0d][162])
- **gitpod:** add `bootstrap` task ([d2ce4f1][163])
- **gitpod:** added more tools to the dockerfile ([79f5f6d][164])
- minor fix ([f9bc049][165])
- minor fix ([9ae11b2][166])
- **pre-commit:** ensure Justfile is identical to upstream in `just-fmt.sh`
  script ([ee99516][167])
- **gitpod:** replace `yarn` with `npm` in Dockerfile ([927e64b][168])
- change image in `.gitpod.yml` ([f494de7][169])
- fix `.gitpod.yml` ([8c3577e][170])

### v0.0.1 (2023-02-12)

#### Features

- **api:** init ([3974f95][171])
- **api/core:** init ([891fa92][172])
- **api/errors:** init ([dc9c0cc][173])
- **api/handlers:** init ([a9354fe][174])
- **api/middlewares:** init ([03877c6][175])
- **api/registry:** init ([c093b2a][176])
- **cmd/podinfo:** init ([a3c1ebf][177])
- **internal/cryptoutil:** init ([34a4597][178])
- **internal/files:** init ([4ac385c][179])
- **internal/golang-lru:** init ([f1264aa][180])
- **internal/locksutil:** init ([09e59d1][181])
- **internal/logger:** init ([e066d10][182])
- **internal/multierror:** init ([a39b7c2][183])
- **internal/pathmanager:** init ([489996c][184])
- **internal/permitpool:** init ([a29c5d7][185])
- **internal/prettyprint:** init ([2bc4ce1][186])
- **internal/primitives:** init ([1a67ad6][187])
- **internal/runtimex:** init ([76eb234][188])
- **internal/testutils:** init ([c188be8][189])
- **internal/urandom:** init ([58ed4ff][190])
- **internal/version:** init ([4a98993][191])
- **sdk/physical:** init ([f8d487e][192])
- **internal/backoff/constant:** init ([f70b48d][193])
- **internal/backoff/exponential:** init ([437e93c][194])
- **internal/cli/data:** init ([9d115ad][195])
- **internal/cli/decoder:** init ([5b380a7][196])
- **internal/cli/flagset:** init ([a233141][197])
- **internal/cli/value:** init ([aef98ca][198])
- **internal/golang-lru/simplelru:** init ([8196569][199])
- **internal/logger/slack:** init ([1e97608][200])
- **internal/radix-tree/immutable:** init ([5dbb2e9][201])
- **internal/radix-tree/mutable:** init ([fade8c6][202])
- **sdk/api/address:** init ([69918d7][203])
- **sdk/api/fastjson:** init ([e5403e6][204])
- **sdk/api/metrics:** init ([fd5e5e2][205])
- **sdk/api/port:** init ([979298e][206])
- **sdk/api/proto:** init ([3ddbd38][207])
- **sdk/api/response:** init ([76ab9c8][208])
- **sdk/api/route:** init ([2a7f6c7][209])
- **sdk/physical/access:** init ([829e8ef][210])
- **sdk/physical/cache:** init ([48e7940][211])
- **sdk/physical/chroot:** init ([5eb4b18][212])
- **sdk/physical/encoding:** init ([b1895bf][213])
- **sdk/physical/error-injector:** init ([fa52696][214])
- **sdk/physical/latency:** init ([7d4928f][215])
- **sdk/physical/retry:** init ([8660a4d][216])
- **cmd/podinfo/commands/server:** init ([540b954][217])
- **cmd/podinfo/commands/version:** init ([df8d8d1][218])
- **docker/release:** minimal `Dockerfile` for the binary ([c4cd6da][219])

#### Documentation

- init ([93e80f2][220])
- **build/go:** `Build` target synopsis ([a9e2bfb][221])
- **just/podinfo:** `run` target synopsis ([966607f][222])
- **just/podinfo:** `kill` target synopsis ([d4bb819][223])
- **just/go:** `build-go` target synopsis ([89c2bae][224])
- **just/go:** `clean-go` target synopsis ([7089f0b][225])
- **just/go:** `lint-go` target synopsis ([25b8479][226])
- **just/go:** `format-go` target synopsis ([1c62db8][227])
- **just/go:** `bootstrap-go` target synopsis ([e37bcd0][228])
- **just/go:** `_build` target synopsis ([50231ce][229])
- **just/go:** `_go` target synopsis ([f240c28][230])
- **just/go:** `_lint-go` target synopsis ([5ac43ba][231])
- **just/semver:** `bootstrap-semver` target synopsis ([92ec6b4][232])
- **just/markdown:** `_format-markdown` target synopsis ([2721074][233])
- **just/justfile:** `format-just` target synopsis ([78a7965][234])
- **just/json:** `format-json` target synopsis ([8c5778c][235])
- **just/json:** `_format-json` target synopsis ([6a417bd][236])
- **just/bash:** `lint-bash` target synopsis ([2e74c8d][237])
- **just/bash:** `format-bash` target synopsis ([b59a5d7][238])
- **just/bash:** `_lint-bash` target synopsis ([08b1ac6][239])
- **just/bash:** `_format-bash` target synopsis ([ef340bb][240])
- **just/misc:** `snapshot` target synopsis ([4026b9e][241])
- **just/misc:** `vscode-tasks` target synopsis ([deb5e1d][242])
- **just/semver:** `generate-changelog` target synopsis ([aa5683b][243])
- **just/semver:** `patch-release` target synopsis ([74afa35][244])
- **just/semver:** `minor-release` target synopsis ([2bde4d8][245])
- **just/semver:** `major-release` target synopsis ([03bb13d][246])
- **just/semver:** variable synopsis ([a5db8af][247])
- **just/commit:** `commit` target synopsis ([d02b807][248])
- **just/commit:** `bootstrap-pre-commit` target synopsis ([c367eae][249])
- **just/commit:** `_pre-commit` target synopsis ([6aee1b8][250])
- **just/git:** `git-add` target synopsis ([f84a9eb][251])
- **just/git:** `_git-delta` target synopsis ([3781d54][252])
- **just/git:** `_git-delta` target synopsis ([b8d961d][253])
- **just/bootstrap:** `_update-rust` target synopsis ([0d1588e][254])
- **just/bootstrap:** `_validate-rust` target synopsis ([b223255][255])
- **just/bootstrap:** `_install-nodejs-package` target synopsis
  ([58aabd6][256])
- **just/bootstrap:** `_bootstrap-nodejs` target synopsis ([00df92c][257])
- **just/bootstrap:** `_core-pkgs` target synopsis ([9a78d0a][258])
- **just/bootstrap:** `_install-os-package` target synopsis ([b817954][259])
- **just/bootstrap:** `_update-os-pkgs` target synopsis ([4b94227][260])
- **just/bootstrap:** `kary-comments` target synopsis ([f80992f][261])
- **just:** common variables ([9cc3843][262])
- **build/go/targets/test:** `Target` function synopsis ([7a17aad][263])
- **build/go/targets:** package synopsis ([40e593d][264])
- **build/go/targets/test:** package synopsis ([7e5375b][265])
- **build/go/targets/build:** package synopsis ([960062d][266])
- **build/go/git:** package synopsis ([2a1ffd4][267])
- **build/go/version:** package synopsis ([265da8c][268])
- **api:** synopsis ([295aad0][269])
- **sdk:** synopsis ([9f0d098][270])
- **api/core:** synopsis ([9ef7b34][271])
- **api/handlers:** synopsis ([b0e0874][272])
- **api/middlewares:** synopsis ([d3233c8][273])
- **api/registry:** synopsis ([e801ead][274])
- **internal/files:** synopsis ([a163f57][275])
- **internal/golang-lru:** synopsis ([d63c0a7][276])
- **internal/logger:** synopsis ([5d65330][277])
- **internal/permitpool:** synopsis ([41feade][278])
- **internal/prettyprint:** synopsis ([87c51ba][279])
- **internal/primitives:** synopsis ([8a083ac][280])
- **internal/runtimex:** synopsis ([dffbbdc][281])
- **internal/testutils:** synopsis ([3895ee7][282])
- **internal/urandom:** synopsis ([ab5c0b9][283])
- **sdk/api:** synopsis ([f657f44][284])
- **sdk/physical:** synopsis ([9706c76][285])
- **cmd/podinfo/commands:** synopsis ([108d9eb][286])
- **internal/cli/data:** synopsis ([3574a9c][287])
- **internal/cli/decoder:** synopsis ([a13ad40][288])
- **internal/cli/flagset:** synopsis ([0a9d0c1][289])
- **internal/logger/slack:** synopsis ([83a078c][290])
- **internal/radix-tree/immutable:** synopsis ([78abe82][291])
- **internal/radix-tree/mutable:** synopsis ([4e53b91][292])
- **sdk/api/address:** synopsis ([23ab44b][293])
- **sdk/api/fastjson:** synopsis ([2a7c790][294])
- **sdk/api/metrics:** synopsis ([c505728][295])
- **sdk/api/port:** synopsis ([1090e11][296])
- **sdk/api/proto:** synopsis ([197fad7][297])
- **sdk/api/response:** synopsis ([5cdbfab][298])
- **sdk/api/route:** synopsis ([6d23ed6][299])
- **sdk/physical/access:** synopsis ([cea7bee][300])
- **sdk/physical/cache:** synopsis ([13e7f7d][301])
- **sdk/physical/chroot:** synopsis ([4b31bb4][302])
- **sdk/physical/encoding:** synopsis ([49a1e33][303])
- **sdk/physical/error-injector:** synopsis ([70446b1][304])
- **sdk/physical/latency:** synopsis ([1f906c5][305])
- **sdk/physical/retry:** synopsis ([13983aa][306])
- **cmd/podinfo/commands/server:** synopsis ([942978f][307])
- **cmd/podinfo/commands/version:** synopsis ([26ea212][308])
- **docker-bake:** usage guide ([5344b78][309])
- **docker-bake:** `release` target synopsis ([e55beca][310])
- **docker-bake:** `default` group synopsis ([baf2270][311])
- **docker-bake:** `TAG` variable synopsis ([abe018f][312])
- **docker-bake:** `AMD64` variable synopsis ([7909900][313])
- **docker-bake:** `ARM64` variable synopsis ([750e36d][314])
- **docker-bake:** `REGISTRY_USERNAME` variable synopsis ([4c68a04][315])
- **docker-bake:** `REGISTRY_HOSTNAME` variable synopsis ([83e5534][316])
- **docker-bake:** `LOCAL` variable synopsis ([e238d0e][317])
- **github:** `programming_task` issue template ([dba5a78][318])
- **github:** `feature_request` issue template ([4124f12][319])
- **github:** `bug_report` issue template ([c7d8513][320])
- **github:** `api_endpoint_spec` issue template ([d60a2a9][321])

#### Refactors

- **mage:** remove old files ([eabe9ea][322])

#### Tests

- **api/core:** init ([0598dda][323])
- **internal/files:** init ([ffb9e6b][324])
- **internal/logger:** init ([1d6b435][325])
- **internal/primitives:** init ([b3ebabc][326])
- **internal/backoff/constant:** init ([c3255c2][327])
- **internal/backoff/exponential:** init ([588c83a][328])
- **internal/cli/decoder:** init ([1b3cfbe][329])
- **internal/cli/value:** init ([4aeaebb][330])
- **sdk/api/fastjson:** init ([01cd7be][331])

#### Build System

- **just/core:** aggregator targets ([3382f77][332])
- **just/podinfo:** `run` target implementation ([e262bfa][333])
- **just/podinfo:** `kill` target implementation ([40a0637][334])
- **just/go:** `build-go` target implementation ([d8670aa][335])
- **just/go:** `clean-go` target implementation ([8dc7e7c][336])
- **just/go:** `lint-go` target implementation ([14209fd][337])
- **just/go:** `format-go` target implementation ([0126826][338])
- **just/go:** `bootstrap-go` target implementation ([39b68ce][339])
- **just/go:** `_build` hidden target implementation ([47dc4e8][340])
- **just/go:** `_go` hidden target implementation ([26a247a][341])
- **just/go:** `_lint-go` hidden target implementation ([351a32a][342])
- **just/semver:** `bootstrap-semver` target implementation ([3ca58f4][343])
- **just/markdown:** `_format-markdown` hidden target implementation
  ([852e53e][344])
- **just/justfile:** `format-just` target implementation ([eb8efa2][345])
- **just/json:** `format-json` target implementation ([e540c34][346])
- **just/json:** `_format-json` hidden target implementation ([2754846][347])
- **just/bash:** `lint-bash` target implementation ([5cfd1f9][348])
- **just/bash:** `format-bash` target implementation ([05d97b0][349])
- **just/bash:** `_lint-bash` hidden target implementation ([2e56839][350])
- **just/bash:** `_format-bash` hidden target implementation ([2214242][351])
- **just/misc:** `snapshot` target implementation ([184f86e][352])
- **just/misc:** `vscode-tasks` target implementation ([8669e48][353])
- **just/semver:** `generate-changelog` target implementation ([d9813b6][354])
- **just/semver:** `patch-release` target implementation ([0ee99d8][355])
- **just/semver:** `minor-release` target implementation ([47c8d9d][356])
- **just/semver:** `major-release` target implementation ([4ca9c5c][357])
- **just/semver:** variable declaration ([fb9c78a][358])
- **just/commit:** `commit` target implementation ([f574bf3][359])
- **just/commit:** `bootstrap-pre-commit` target implementation
  ([1243472][360])
- **just/git:** `_pre-commit` hidden target implementation ([e5c5206][361])
- **just/git:** `git-add` target implementation ([b053a64][362])
- **just/git:** `git-fetch` target implementation ([28764fb][363])
- **just/git:** `_git-delta` hidden target implementation ([33b956f][364])
...
- **just/bootstrap:** `_update-os-pkgs` hidden target implementation
  ([7fb7d14][372])
- **just/bootstrap:** `kary-comments` target implementation ([8ffe083][373])
- **just:** common config ([86033e0][374])
- **go:** moved from `magefile.go` ([52e7886][375])
- **go/targets/test:** moved from `mage/test` ([84ef4a7][376])
- **go/targets/build:** moved from `mage/build` ([a07a063][377])
- **go/git:** moved from `mage/git` ([ae05d7a][378])
- **go/version:** moved from `internal/version` ([1906bdc][379])
- **docker-bake:** `release` target implementation ([778b6f7][380])
- **docker-bake:** `TAG` variable declaration ([dd58811][381])
- **docker-bake:** `AMD64` variable declaration ([763dcb7][382])
- **docker-bake:** `ARM64` variable declaration ([7feeae8][383])
- **docker-bake:** `REGISTRY_USERNAME` variable declaration ([c0493f8][384])
- **docker-bake:** `REGISTRY_HOSTNAME` variable declaration ([0cebd31][385])
- **docker-bake:** `LOCAL` variable declaration ([a89e0be][386])
- **docker/release:** added buildx installer/setup to the script
  ([607964a][387])
- **docker/release:** multi-arch builder script ([2d320e6][388])
- `go-releaser` config ([25bea21][389])
- **mage:** `magefile` init ([2e7af35][390])
- **test:** `test` mage targets ([84e27ca][391])
- **build:** `build` mage targets ([5471c34][392])
- **git:** `git` auxiliary library ([4908743][393])

#### CI

- **github:** `release` workflow ([fc1e8f4][394])
- **github:** `go` workflow ([299d59e][395])
- **github:** `docker` workflow ([4e9b676][396])

#### Chore

- **pre-commit:** `just-fmt` pre-commit hook ([57b16f2][397])
- **pre-commit:** `md-fmt` pre-commit hook ([8c4b6c4][398])
- **docs:** fix `markdown` file exception `.gitignore` ([b501fa4][399])
- **build:** local `.gitignore` ([755f5d2][400])
- **internal:** local `.gitignore` ([825e7c2][401])
- **sdk:** local `.gitignore` ([f55402b][402])
- **cmd:** local `.gitignore` ([6ff23fe][403])
- **api:** local `.gitignore` ([a160290][404])
- **docs:** local `.gitignore` ([fbfd5b7][405])
- **assets:** local `.gitignore` ([502e7a5][406])
- **fixtures:** local `.gitignore` ([7a098f4][407])
- simplify `.editorconfig` file ([b61d49c][408])
- fixed `.editorconfig` file ([a8db8f7][409])
- **pre-commit:** `go-mod-tidy` pre-commit hook ([713d5ab][410])
- **pre-commit:** `go-fmt` pre-commit hook ([2fbb351][411])
- **github:** `CODEOWNERS` file ([7d5618d][412])
- **vscode:** `tasks` configuration file ([8d9e1cd][413])
- **vscode:** `settings` configuration file ([3ec3faf][414])
- **vscode:** `launch` configuration file ([7ab2d30][415])
- **vscode:** `extensions` configuration file ([2f05faf][416])
- `gitpod` config ([6aeea05][417])
- go vendor dependency management with `tools.go` ([82fea78][418])
- `.env` file init ([24c7238][419])
- `pre-commit` config file ([3d8d786][420])
- **linter:** `cspell` golang dictionary ([7b20441][421])
- **linter:** `cspell` generic dictionary ([b95cfbe][422])
- **linter:** `cspell` config file ([63d43ce][423])
- **linter:** `golangci` config file ([87a9658][424])
- **linter:** `revive` config file ([40abb30][425])
- **linter:** `.markdownlintignore` file ([eb1bae8][426])
- `.versionrc` file ([bee9668][427])
- `.stignore` file ([5bb284d][428])
- `.editorconfig` file ([640d343][429])
- `.dockerignore` file ([aabfa50][430])
- `gitignore` file ([8c88606][431])
- **linter:** `commitlint` config ([4f34502][432])

[1]: https://github.com/da-moon/northern-labs-interview/compare/v0.6.3...v0.7.0
[2]:
...
[9]: https://github.com/da-moon/northern-labs-interview/compare/v0.6.2...v0.6.3
[10]:
