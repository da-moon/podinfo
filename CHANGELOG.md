...
- **api/handlers:** register `/headers` route in `Initialize()` ([10cef5d][2])
- **api/handlers/headers:** route `register` implementation ([989f948][3])
- **api/handlers/headers:** `handler` implementation ([9871e64][4])
- **api/handlers/headers:** `response` type ([019355e][5])

### Documentation

- **api/handlers/headers:** package synopsis ([489218a][6])

### Build System

- **build/just/podinfo:** `headers-probe` recipe ([239a061][7])

## [v0.3.0][8] (2023-02-15)

### Features

- **api/handlers:** register `/env` route in `Initialize()` ([2d98b6a][9])
- **api/handlers/env:** routte `register` implementation ([958bc47][10])
- **api/handlers/env:** `handler` implementation ([0ef5a8f][11])
- **api/handlers/env:** `response` type ([877b7e4][12])

### Documentation

- **api/handlers/env:** package synopsis ([edc489e][13])

### Build System

- **build/just/podinfo:** `env-probe` recipe ([b66f28b][14])
...
- **api/handlers:** register `/readyz/enable` route in `Initialize()`
  ([dead392][16])
- **api/handlers/readiness/enable:** route init ([b56a400][17])
- **api/handlers/readiness/enable:** handler setup ([9356de0][18])

#### Documentation

- **api/handlers/readiness/enable:** package synopsis ([faeaf50][19])

#### Build System

- **build/just/podinfo:** `readiness-probe-enable` recipe ([65c6272][20])

### [v0.2.1][21] (2023-02-15)

#### Features

- **api/handlers:** register the route in `Initialize()` ([ae99b84][22])
...
- **api/handlers/readiness/disable:** `HandlerFn` synopsis ([ac1c0ee][30])
- **api/handlers/readiness/disable:** `handler` struct synopsis ([5e8ae1e][31])
- **api/handlers/readiness/disable:** package synopsis ([4753ee2][32])
- **changelog:** v0.2.0 ([2ec37fc][33])

#### Build System

- **build/just/podinfo:** `readiness-probe-disable` recipe ([f0efeb5][34])

## [v0.2.0][35] (2023-02-15)

### Features

- **api/handlers/readiness:** `handler.Register()` implementation
  ([229f6ef][36])
- **api/handlers/readiness:** `init()` implementation ([316c88d][37])
- **api/handlers/readiness:** `HandlerFn` implementation ([fa4e4e0][38])
- **api/handlers/readiness:** `handler.GetStatus()` implementation
  ([6975ceb][39])
- **api/handlers/readiness:** `handler.SetStatus()` implementation
  ([0ae4c75][40])
- **api/handlers/readiness:** `handler.GetLogger()` synopsis ([1fb4903][41])
- **api/handlers/readiness:** `handler.GetLogger()` implementation
  ([2af2f25][42])
- **api/handlers/readiness:** `handler.SetLogger()` implementation
  ([a34f22d][43])
- **api/handlers/readiness:** `handler` struct implementation ([4a73558][44])
- **api/handlers/readiness:** `Response` struct implementation ([8ea8855][45])
- **api/handlers/readiness:** `Status.String()` implementation ([f81e205][46])
- **api/handlers/readiness:** `Status` enum ([c45a277][47])
- **sdk/api/response:** `LogEntry()` implementation ([c62180d][48])

### Documentation

- **build/just/podinfo:** `readiness-probe` recipe ([a989ce1][49])
- **api/handlers/readiness:** `HandlerFn` synopsis ([5b226c3][50])
- **api/handlers/readiness:** `handler.GetStatus()` synopsis ([7f85163][51])
- **api/handlers/readiness:** `handler.SetStatus()` synopsis ([db54578][52])
- **api/handlers/readiness:** `handler.SetLogger()` synopsis ([2ac7d67][53])
- **api/handlers/readiness:** `handler` struct synopsis ([14fcb57][54])
- **api/handlers/readiness:** `Response` struct synopsis ([7c7ecff][55])
- **api/handlers/readiness:** `Status.String()` synopsis ([777320c][56])
- **api/handlers/readiness:** `Status` enum ([9788dfb][57])
- **api/handlers/readiness:** package synopsis ([92c17f3][58])
- **sdk/api/response:** `LogEntry()` synopsis ([c9c5f7d][59])
- **changelog:** v0.2.0 ([c46195b][60])

### Refactors

- **api/handlers/liveness:** new pattern of writing `HandlerFn` ([d270881][61])
- **sdk/api/response:** `Write` function ([66fd066][62])
- **api/handlers/liveness:** change route impl pattern ([6efbf25][63])

### Build System

- **build/just/podinfo:** `readiness-probe` recipe ([14a6fe0][64])

### Chore

- **gitpod:** fix `gitpod` shell config in dockerfile ([ad05fc9][65])

### [v0.1.1][66] (2023-02-13)

#### Documentation

- **changelog:** `v0.1.0` ([e1bdb33][67])

#### Build System

- **just/git:** prune refs in `git-fetch` recipe ([69d5e05][68])

## [v0.1.0][69] (2023-02-13)

### Features

- **sdk/api/response:** `WriteJSON()` function implementation ([ac8c96c][70])
- **sdk/api/response:** `WriteSuccessfulJSONRaw()` function implementation
  ([f264be1][71])
- **api/handlers:** remove `Prefix` from pre-flight handler ([ae48e9d][72])
- **api/handlers:** Register and initialize `kubernetes-liveness-probe` route
  ([1c416f5][73])
- **api/handlers/liveness:** `Initialize()` function ([73548a0][74])
- **api/handlers/liveness:** `New()` function ([016f07c][75])
- **api/handlers/liveness:** `Handler` struct ([133a5a8][76])
- **api/handlers/liveness:** package constants ([a0b8f71][77])
- **api/handlers/liveness:** `Response` struct ([9bc1341][78])

### Bug Fixes

- **sdk/api/response:** address linter complaints ([a9eed4e][79])

### Documentation

- **docker/buildx:** `gitpod` target ([11b8055][80])
- `liveness-probe` instruction ([fc5852c][81])
- **sdk/api/response:** `WriteJSON()` function synopsis ([7e25e0a][82])
- **sdk/api/response:** `WriteSuccessfulJSONRaw()` synopsis ([63d16c4][83])
- **swaggger:** add `GET` verb for `/healthz` ([5a0bb54][84])
- fix instruction to run mage's `build` target ([d35f513][85])
- **api/handlers/liveness:** `Initialize()` function ([a8993b7][86])
- **api/handlers/liveness:** `New()` function ([add5240][87])
- **api/handlers/liveness:** `Handler` struct ([06f7e41][88])
- **api/handlers/liveness:** package constants ([0e5f809][89])
- **api/handlers/liveness:** `Status` enum ([2ac0c5e][90])
- **api/handlers/liveness:** package synopsis ([efe22ac][91])
- **changelog:** updated changelog for v0.0.1 ([533f465][92])

### Refactors

- **api/handlers/liveness:** update `handler()` to write response json without
  adding additional fields ([985c2cf][93])
...
- **go-releaser:** do not sign archive ([b931100][96])
- **docker:** `gitpod` target ([006af3c][97])
- **just/bootstrap:** add `rust` toolchain ([6d9e725][98])
- **docker:** laxer package versioning in dockerfile ([9db2bb8][99])
- **docker:** fixed minor issues with `docker-bake.hcl` file ([747b4f4][100])
- **just/bootstrap:** add `bootstrap-os-pkgs` dependency to `bootstrap` target
  ([c397414][101])
- **just/go:** fix `mage` install in `_build-go` target ([7a6a5d9][102])
- **just/commit:** fix `bootstrap-pre-commit` hook installation
  ([495f420][103])
- **just/semver:** changed changelog commit message pattern ([9a5964e][104])

### CI

- **docker:** detect `TAG` ([5ca9bde][105])
- **go:** add `go-releaser` step ([74090a2][106])
- **release:** fix deprecated flags in `go-releaser` step ([0c641be][107])
- update min go version to `1.20` ([385d829][108])
- **go:** fixed arguments in `test` step ([2e45224][109])
- **go:** fixed arguments in `build` step ([55e6ae7][110])
- **release:** remove `unshallow` step ([2011e4f][111])
- **release:** update `setup-go` and `goreleaser-action` actions
  ([ea4cc92][112])

### Chore

- **gitpod:** source `gitpod` variables ([168e63f][113])
- **gitpod:** `rust` toolchain configuration ([e3e3d0d][114])
- **gitpod:** add `bootstrap` task ([d2ce4f1][115])
- **gitpod:** added more tools to the dockerfile ([79f5f6d][116])
- minor fix ([f9bc049][117])
- minor fix ([9ae11b2][118])
- **pre-commit:** ensure Justfile is identical to upstream in `just-fmt.sh`
  script ([ee99516][119])
- **gitpod:** replace `yarn` with `npm` in Dockerfile ([927e64b][120])
- change image in `.gitpod.yml` ([f494de7][121])
- fix `.gitpod.yml` ([8c3577e][122])

### v0.0.1 (2023-02-12)

#### Features

- **api:** init ([3974f95][123])
- **api/core:** init ([891fa92][124])
- **api/errors:** init ([dc9c0cc][125])
- **api/handlers:** init ([a9354fe][126])
- **api/middlewares:** init ([03877c6][127])
- **api/registry:** init ([c093b2a][128])
- **cmd/podinfo:** init ([a3c1ebf][129])
- **internal/cryptoutil:** init ([34a4597][130])
- **internal/files:** init ([4ac385c][131])
- **internal/golang-lru:** init ([f1264aa][132])
- **internal/locksutil:** init ([09e59d1][133])
- **internal/logger:** init ([e066d10][134])
- **internal/multierror:** init ([a39b7c2][135])
- **internal/pathmanager:** init ([489996c][136])
- **internal/permitpool:** init ([a29c5d7][137])
- **internal/prettyprint:** init ([2bc4ce1][138])
- **internal/primitives:** init ([1a67ad6][139])
- **internal/runtimex:** init ([76eb234][140])
- **internal/testutils:** init ([c188be8][141])
- **internal/urandom:** init ([58ed4ff][142])
- **internal/version:** init ([4a98993][143])
- **sdk/physical:** init ([f8d487e][144])
- **internal/backoff/constant:** init ([f70b48d][145])
- **internal/backoff/exponential:** init ([437e93c][146])
- **internal/cli/data:** init ([9d115ad][147])
- **internal/cli/decoder:** init ([5b380a7][148])
- **internal/cli/flagset:** init ([a233141][149])
- **internal/cli/value:** init ([aef98ca][150])
- **internal/golang-lru/simplelru:** init ([8196569][151])
- **internal/logger/slack:** init ([1e97608][152])
- **internal/radix-tree/immutable:** init ([5dbb2e9][153])
- **internal/radix-tree/mutable:** init ([fade8c6][154])
- **sdk/api/address:** init ([69918d7][155])
- **sdk/api/fastjson:** init ([e5403e6][156])
- **sdk/api/metrics:** init ([fd5e5e2][157])
- **sdk/api/port:** init ([979298e][158])
- **sdk/api/proto:** init ([3ddbd38][159])
- **sdk/api/response:** init ([76ab9c8][160])
- **sdk/api/route:** init ([2a7f6c7][161])
- **sdk/physical/access:** init ([829e8ef][162])
- **sdk/physical/cache:** init ([48e7940][163])
- **sdk/physical/chroot:** init ([5eb4b18][164])
- **sdk/physical/encoding:** init ([b1895bf][165])
- **sdk/physical/error-injector:** init ([fa52696][166])
- **sdk/physical/latency:** init ([7d4928f][167])
- **sdk/physical/retry:** init ([8660a4d][168])
- **cmd/podinfo/commands/server:** init ([540b954][169])
- **cmd/podinfo/commands/version:** init ([df8d8d1][170])
- **docker/release:** minimal `Dockerfile` for the binary ([c4cd6da][171])

#### Documentation

- init ([93e80f2][172])
- **build/go:** `Build` target synopsis ([a9e2bfb][173])
- **just/podinfo:** `run` target synopsis ([966607f][174])
- **just/podinfo:** `kill` target synopsis ([d4bb819][175])
- **just/go:** `build-go` target synopsis ([89c2bae][176])
- **just/go:** `clean-go` target synopsis ([7089f0b][177])
- **just/go:** `lint-go` target synopsis ([25b8479][178])
- **just/go:** `format-go` target synopsis ([1c62db8][179])
- **just/go:** `bootstrap-go` target synopsis ([e37bcd0][180])
- **just/go:** `_build` target synopsis ([50231ce][181])
- **just/go:** `_go` target synopsis ([f240c28][182])
- **just/go:** `_lint-go` target synopsis ([5ac43ba][183])
- **just/semver:** `bootstrap-semver` target synopsis ([92ec6b4][184])
- **just/markdown:** `_format-markdown` target synopsis ([2721074][185])
- **just/justfile:** `format-just` target synopsis ([78a7965][186])
- **just/json:** `format-json` target synopsis ([8c5778c][187])
- **just/json:** `_format-json` target synopsis ([6a417bd][188])
- **just/bash:** `lint-bash` target synopsis ([2e74c8d][189])
- **just/bash:** `format-bash` target synopsis ([b59a5d7][190])
- **just/bash:** `_lint-bash` target synopsis ([08b1ac6][191])
- **just/bash:** `_format-bash` target synopsis ([ef340bb][192])
- **just/misc:** `snapshot` target synopsis ([4026b9e][193])
- **just/misc:** `vscode-tasks` target synopsis ([deb5e1d][194])
- **just/semver:** `generate-changelog` target synopsis ([aa5683b][195])
- **just/semver:** `patch-release` target synopsis ([74afa35][196])
- **just/semver:** `minor-release` target synopsis ([2bde4d8][197])
- **just/semver:** `major-release` target synopsis ([03bb13d][198])
- **just/semver:** variable synopsis ([a5db8af][199])
- **just/commit:** `commit` target synopsis ([d02b807][200])
- **just/commit:** `bootstrap-pre-commit` target synopsis ([c367eae][201])
- **just/commit:** `_pre-commit` target synopsis ([6aee1b8][202])
- **just/git:** `git-add` target synopsis ([f84a9eb][203])
- **just/git:** `_git-delta` target synopsis ([3781d54][204])
- **just/git:** `_git-delta` target synopsis ([b8d961d][205])
- **just/bootstrap:** `_update-rust` target synopsis ([0d1588e][206])
- **just/bootstrap:** `_validate-rust` target synopsis ([b223255][207])
- **just/bootstrap:** `_install-nodejs-package` target synopsis
  ([58aabd6][208])
- **just/bootstrap:** `_bootstrap-nodejs` target synopsis ([00df92c][209])
- **just/bootstrap:** `_core-pkgs` target synopsis ([9a78d0a][210])
- **just/bootstrap:** `_install-os-package` target synopsis ([b817954][211])
- **just/bootstrap:** `_update-os-pkgs` target synopsis ([4b94227][212])
- **just/bootstrap:** `kary-comments` target synopsis ([f80992f][213])
- **just:** common variables ([9cc3843][214])
- **build/go/targets/test:** `Target` function synopsis ([7a17aad][215])
- **build/go/targets:** package synopsis ([40e593d][216])
- **build/go/targets/test:** package synopsis ([7e5375b][217])
- **build/go/targets/build:** package synopsis ([960062d][218])
- **build/go/git:** package synopsis ([2a1ffd4][219])
- **build/go/version:** package synopsis ([265da8c][220])
- **api:** synopsis ([295aad0][221])
- **sdk:** synopsis ([9f0d098][222])
- **api/core:** synopsis ([9ef7b34][223])
- **api/handlers:** synopsis ([b0e0874][224])
- **api/middlewares:** synopsis ([d3233c8][225])
- **api/registry:** synopsis ([e801ead][226])
- **internal/files:** synopsis ([a163f57][227])
- **internal/golang-lru:** synopsis ([d63c0a7][228])
- **internal/logger:** synopsis ([5d65330][229])
- **internal/permitpool:** synopsis ([41feade][230])
- **internal/prettyprint:** synopsis ([87c51ba][231])
- **internal/primitives:** synopsis ([8a083ac][232])
- **internal/runtimex:** synopsis ([dffbbdc][233])
- **internal/testutils:** synopsis ([3895ee7][234])
- **internal/urandom:** synopsis ([ab5c0b9][235])
- **sdk/api:** synopsis ([f657f44][236])
- **sdk/physical:** synopsis ([9706c76][237])
- **cmd/podinfo/commands:** synopsis ([108d9eb][238])
- **internal/cli/data:** synopsis ([3574a9c][239])
- **internal/cli/decoder:** synopsis ([a13ad40][240])
- **internal/cli/flagset:** synopsis ([0a9d0c1][241])
- **internal/logger/slack:** synopsis ([83a078c][242])
- **internal/radix-tree/immutable:** synopsis ([78abe82][243])
- **internal/radix-tree/mutable:** synopsis ([4e53b91][244])
- **sdk/api/address:** synopsis ([23ab44b][245])
- **sdk/api/fastjson:** synopsis ([2a7c790][246])
- **sdk/api/metrics:** synopsis ([c505728][247])
- **sdk/api/port:** synopsis ([1090e11][248])
- **sdk/api/proto:** synopsis ([197fad7][249])
- **sdk/api/response:** synopsis ([5cdbfab][250])
- **sdk/api/route:** synopsis ([6d23ed6][251])
- **sdk/physical/access:** synopsis ([cea7bee][252])
- **sdk/physical/cache:** synopsis ([13e7f7d][253])
- **sdk/physical/chroot:** synopsis ([4b31bb4][254])
- **sdk/physical/encoding:** synopsis ([49a1e33][255])
- **sdk/physical/error-injector:** synopsis ([70446b1][256])
- **sdk/physical/latency:** synopsis ([1f906c5][257])
- **sdk/physical/retry:** synopsis ([13983aa][258])
- **cmd/podinfo/commands/server:** synopsis ([942978f][259])
- **cmd/podinfo/commands/version:** synopsis ([26ea212][260])
- **docker-bake:** usage guide ([5344b78][261])
- **docker-bake:** `release` target synopsis ([e55beca][262])
- **docker-bake:** `default` group synopsis ([baf2270][263])
- **docker-bake:** `TAG` variable synopsis ([abe018f][264])
- **docker-bake:** `AMD64` variable synopsis ([7909900][265])
- **docker-bake:** `ARM64` variable synopsis ([750e36d][266])
- **docker-bake:** `REGISTRY_USERNAME` variable synopsis ([4c68a04][267])
- **docker-bake:** `REGISTRY_HOSTNAME` variable synopsis ([83e5534][268])
- **docker-bake:** `LOCAL` variable synopsis ([e238d0e][269])
- **github:** `programming_task` issue template ([dba5a78][270])
- **github:** `feature_request` issue template ([4124f12][271])
- **github:** `bug_report` issue template ([c7d8513][272])
- **github:** `api_endpoint_spec` issue template ([d60a2a9][273])

#### Refactors

- **mage:** remove old files ([eabe9ea][274])

#### Tests

- **api/core:** init ([0598dda][275])
- **internal/files:** init ([ffb9e6b][276])
- **internal/logger:** init ([1d6b435][277])
- **internal/primitives:** init ([b3ebabc][278])
- **internal/backoff/constant:** init ([c3255c2][279])
- **internal/backoff/exponential:** init ([588c83a][280])
- **internal/cli/decoder:** init ([1b3cfbe][281])
- **internal/cli/value:** init ([4aeaebb][282])
- **sdk/api/fastjson:** init ([01cd7be][283])

#### Build System

- **just/core:** aggregator targets ([3382f77][284])
- **just/podinfo:** `run` target implementation ([e262bfa][285])
- **just/podinfo:** `kill` target implementation ([40a0637][286])
- **just/go:** `build-go` target implementation ([d8670aa][287])
- **just/go:** `clean-go` target implementation ([8dc7e7c][288])
- **just/go:** `lint-go` target implementation ([14209fd][289])
- **just/go:** `format-go` target implementation ([0126826][290])
- **just/go:** `bootstrap-go` target implementation ([39b68ce][291])
- **just/go:** `_build` hidden target implementation ([47dc4e8][292])
- **just/go:** `_go` hidden target implementation ([26a247a][293])
- **just/go:** `_lint-go` hidden target implementation ([351a32a][294])
- **just/semver:** `bootstrap-semver` target implementation ([3ca58f4][295])
- **just/markdown:** `_format-markdown` hidden target implementation
  ([852e53e][296])
- **just/justfile:** `format-just` target implementation ([eb8efa2][297])
- **just/json:** `format-json` target implementation ([e540c34][298])
- **just/json:** `_format-json` hidden target implementation ([2754846][299])
- **just/bash:** `lint-bash` target implementation ([5cfd1f9][300])
- **just/bash:** `format-bash` target implementation ([05d97b0][301])
- **just/bash:** `_lint-bash` hidden target implementation ([2e56839][302])
- **just/bash:** `_format-bash` hidden target implementation ([2214242][303])
- **just/misc:** `snapshot` target implementation ([184f86e][304])
- **just/misc:** `vscode-tasks` target implementation ([8669e48][305])
- **just/semver:** `generate-changelog` target implementation ([d9813b6][306])
- **just/semver:** `patch-release` target implementation ([0ee99d8][307])
- **just/semver:** `minor-release` target implementation ([47c8d9d][308])
- **just/semver:** `major-release` target implementation ([4ca9c5c][309])
- **just/semver:** variable declaration ([fb9c78a][310])
- **just/commit:** `commit` target implementation ([f574bf3][311])
- **just/commit:** `bootstrap-pre-commit` target implementation
  ([1243472][312])
- **just/git:** `_pre-commit` hidden target implementation ([e5c5206][313])
- **just/git:** `git-add` target implementation ([b053a64][314])
- **just/git:** `git-fetch` target implementation ([28764fb][315])
- **just/git:** `_git-delta` hidden target implementation ([33b956f][316])
...
- **just/bootstrap:** `_update-os-pkgs` hidden target implementation
  ([7fb7d14][324])
- **just/bootstrap:** `kary-comments` target implementation ([8ffe083][325])
- **just:** common config ([86033e0][326])
- **go:** moved from `magefile.go` ([52e7886][327])
- **go/targets/test:** moved from `mage/test` ([84ef4a7][328])
- **go/targets/build:** moved from `mage/build` ([a07a063][329])
- **go/git:** moved from `mage/git` ([ae05d7a][330])
- **go/version:** moved from `internal/version` ([1906bdc][331])
- **docker-bake:** `release` target implementation ([778b6f7][332])
- **docker-bake:** `TAG` variable declaration ([dd58811][333])
- **docker-bake:** `AMD64` variable declaration ([763dcb7][334])
- **docker-bake:** `ARM64` variable declaration ([7feeae8][335])
- **docker-bake:** `REGISTRY_USERNAME` variable declaration ([c0493f8][336])
- **docker-bake:** `REGISTRY_HOSTNAME` variable declaration ([0cebd31][337])
- **docker-bake:** `LOCAL` variable declaration ([a89e0be][338])
- **docker/release:** added buildx installer/setup to the script
  ([607964a][339])
- **docker/release:** multi-arch builder script ([2d320e6][340])
- `go-releaser` config ([25bea21][341])
- **mage:** `magefile` init ([2e7af35][342])
- **test:** `test` mage targets ([84e27ca][343])
- **build:** `build` mage targets ([5471c34][344])
- **git:** `git` auxiliary library ([4908743][345])

#### CI

- **github:** `release` workflow ([fc1e8f4][346])
- **github:** `go` workflow ([299d59e][347])
- **github:** `docker` workflow ([4e9b676][348])

#### Chore

- **pre-commit:** `just-fmt` pre-commit hook ([57b16f2][349])
- **pre-commit:** `md-fmt` pre-commit hook ([8c4b6c4][350])
- **docs:** fix `markdown` file exception `.gitignore` ([b501fa4][351])
- **build:** local `.gitignore` ([755f5d2][352])
- **internal:** local `.gitignore` ([825e7c2][353])
- **sdk:** local `.gitignore` ([f55402b][354])
- **cmd:** local `.gitignore` ([6ff23fe][355])
- **api:** local `.gitignore` ([a160290][356])
- **docs:** local `.gitignore` ([fbfd5b7][357])
- **assets:** local `.gitignore` ([502e7a5][358])
- **fixtures:** local `.gitignore` ([7a098f4][359])
- simplify `.editorconfig` file ([b61d49c][360])
- fixed `.editorconfig` file ([a8db8f7][361])
- **pre-commit:** `go-mod-tidy` pre-commit hook ([713d5ab][362])
- **pre-commit:** `go-fmt` pre-commit hook ([2fbb351][363])
- **github:** `CODEOWNERS` file ([7d5618d][364])
- **vscode:** `tasks` configuration file ([8d9e1cd][365])
- **vscode:** `settings` configuration file ([3ec3faf][366])
- **vscode:** `launch` configuration file ([7ab2d30][367])
- **vscode:** `extensions` configuration file ([2f05faf][368])
- `gitpod` config ([6aeea05][369])
- go vendor dependency management with `tools.go` ([82fea78][370])
- `.env` file init ([24c7238][371])
- `pre-commit` config file ([3d8d786][372])
- **linter:** `cspell` golang dictionary ([7b20441][373])
- **linter:** `cspell` generic dictionary ([b95cfbe][374])
- **linter:** `cspell` config file ([63d43ce][375])
- **linter:** `golangci` config file ([87a9658][376])
- **linter:** `revive` config file ([40abb30][377])
- **linter:** `.markdownlintignore` file ([eb1bae8][378])
- `.versionrc` file ([bee9668][379])
- `.stignore` file ([5bb284d][380])
- `.editorconfig` file ([640d343][381])
- `.dockerignore` file ([aabfa50][382])
- `gitignore` file ([8c88606][383])
- **linter:** `commitlint` config ([4f34502][384])

[1]: https://github.com/da-moon/northern-labs-interview/compare/v0.3.0...v0.4.0
[2]:
...
[8]: https://github.com/da-moon/northern-labs-interview/compare/v0.2.2...v0.3.0
[9]:
