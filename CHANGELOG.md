...
- add some instructions and context ([344ff9a][2])
- update `just` target in main `README` file ([68e9779][3])
- add `Roadmap` ([a3b0242][4])
- `swagger` yaml ([efb738c][5])
- **changelog:** v0.7.0 ([13a5032][6])

## [v0.7.0][7] (2023-02-15)

### Features

- **cmd/podinfo/commands/server:** parse redis info with flags ([8e57115][8])
- **api/handlers/cache:** register **DELETE** `/cache/{key}` route in API group
  `Register()` ([a5ab3a8][9])
- **api/handlers/cache:** register **DELETE** `/cache/{key}` route in API group
  `Register()` ([d12f7db][10])
- **api/handlers/cache/delete:** `handler` implementation ([07c94d5][11])

### Documentation

- added code stats ([3e0e1ef][12])
- **api/handlers/cache/delete:** package synopsis ([d0e25cb][13])
- **changelog:** v0.7.0 ([8b5e5d2][14])

### [v0.6.3][15] (2023-02-15)

#### Features

- **api/handlers/cache:** register **GET** `/cache/{key}` route in API group
  `Register()` ([ab70334][16])
- **api/handlers/cache/get:** route `register` implementation ([9935643][17])
- **api/handlers/cache/get:** `handler` implementation ([f154df8][18])

#### Documentation

- **api/handlers/cache/doc:** package synopsis ([9de9d35][19])
- **changelog:** v0.7.0 ([61739b5][20])

### [v0.6.2][21] (2023-02-15)

#### Features

- **api/handlers/cache:** register **PUT** `/cache/{key}` route in API group
  `Register()` ([b7cb2ba][22])
- **api/handlers/cache/put:** route `register` implementation ([6696e26][23])
- **api/handlers/cache/put:** `handler` implementation ([15a177c][24])

#### Documentation

- **api/handlers/cache/put:** package synopsis ([26257c2][25])
- **changelog:** v0.7.0 ([1b6e7f1][26])

### [v0.6.1][27] (2023-02-15)

#### Features

- **api/handlers/cache:** register **POST** `/cache/{key}` route in API group
  `Register()` ([f2f2164][28])
- **api/handlers/cache/post:** route `register` implementation ([fb15f04][29])
- **api/handlers/cache/post:** `handler` implementation ([86f9e9d][30])

#### Documentation

- **api/handlers/cache:** package synopsis ([1e8dc7e][31])
- **api/handlers/cache/post:** package synopsis ([f878c09][32])
- **changelog:** v0.6.0 ([cf372a5][33])

## [v0.6.0][34] (2023-02-15)

### Features

- **api/handlers/cache/shared:** `preflight` request handler ([489db81][35])
- **api/handlers/cache/shared:** `API group` shared constructs ([47b687d][36])
- **cmd/podinfo/commands/server:** flags to read `redis` config ([76a07eb][37])
- **api/core:** add `redis` configuration fields and methods ([cc54fcf][38])
- **internal/cli/value:** handle `int` type cli flags ([d26c406][39])

### Documentation

- **api/handlers/cache/shared:** package synopsis ([2732306][40])
- **changelog:** v0.5.0 ([c313777][41])
...
- **docker/podinfo:** minor changes to build script ([9e7f04a][44])

### Chore

- **re-commit:** hook updates ([bff048a][45])

## [v0.5.0][46] (2023-02-15)

### [v0.4.1][47] (2023-02-15)

#### Features

- **api/handlers:** register **GET** `/delay/{seconds}` route in `Initialize()`
  ([5a9dc8e][48])
- **api/handlers/delay:** route `register` implementation ([f39830b][49])
- **api/handlers/delay:** `handler` implementation ([bf469a3][50])
- **api/handlers/delay:** `response` setup ([d22dc78][51])

#### Documentation

- **changelog:** v0.5.0 ([c313777][41])
- **api/handlers/delay:** package synopsis ([e260245][52])
- **changelog:** v0.4.0 ([d7d5af7][53])

#### Build System

- **build/just/podinfo:** `delay-probe` recipe ([9d0b55f][54])

## [v0.4.0][55] (2023-02-15)

### Features

- **api/handlers:** register `/headers` route in `Initialize()` ([10cef5d][56])
- **api/handlers/headers:** route `register` implementation ([989f948][57])
- **api/handlers/headers:** `handler` implementation ([9871e64][58])
- **api/handlers/headers:** `response` type ([019355e][59])

### Documentation

- **api/handlers/headers:** package synopsis ([489218a][60])

### Build System

- **build/just/podinfo:** `headers-probe` recipe ([239a061][61])

## [v0.3.0][62] (2023-02-15)

### Features

- **api/handlers:** register `/env` route in `Initialize()` ([2d98b6a][63])
- **api/handlers/env:** routte `register` implementation ([958bc47][64])
- **api/handlers/env:** `handler` implementation ([0ef5a8f][65])
- **api/handlers/env:** `response` type ([877b7e4][66])

### Documentation

- **api/handlers/env:** package synopsis ([edc489e][67])

### Build System

- **build/just/podinfo:** `env-probe` recipe ([b66f28b][68])

### [v0.2.2][69] (2023-02-15)

#### Features

- **api/handlers:** register `/readyz/enable` route in `Initialize()`
  ([dead392][70])
- **api/handlers/readiness/enable:** route init ([b56a400][71])
- **api/handlers/readiness/enable:** handler setup ([9356de0][72])

#### Documentation

- **api/handlers/readiness/enable:** package synopsis ([faeaf50][73])

#### Build System

- **build/just/podinfo:** `readiness-probe-enable` recipe ([65c6272][74])

### [v0.2.1][75] (2023-02-15)

#### Features

- **api/handlers:** register the route in `Initialize()` ([ae99b84][76])
...
- **api/handlers/readiness/disable:** `HandlerFn` synopsis ([ac1c0ee][84])
- **api/handlers/readiness/disable:** `handler` struct synopsis ([5e8ae1e][85])
- **api/handlers/readiness/disable:** package synopsis ([4753ee2][86])
- **changelog:** v0.2.0 ([2ec37fc][87])

#### Build System

- **build/just/podinfo:** `readiness-probe-disable` recipe ([f0efeb5][88])

## [v0.2.0][89] (2023-02-15)

### Features

- **api/handlers/readiness:** `handler.Register()` implementation
  ([229f6ef][90])
- **api/handlers/readiness:** `init()` implementation ([316c88d][91])
- **api/handlers/readiness:** `HandlerFn` implementation ([fa4e4e0][92])
- **api/handlers/readiness:** `handler.GetStatus()` implementation
  ([6975ceb][93])
- **api/handlers/readiness:** `handler.SetStatus()` implementation
  ([0ae4c75][94])
- **api/handlers/readiness:** `handler.GetLogger()` synopsis ([1fb4903][95])
- **api/handlers/readiness:** `handler.GetLogger()` implementation
  ([2af2f25][96])
- **api/handlers/readiness:** `handler.SetLogger()` implementation
  ([a34f22d][97])
- **api/handlers/readiness:** `handler` struct implementation ([4a73558][98])
- **api/handlers/readiness:** `Response` struct implementation ([8ea8855][99])
- **api/handlers/readiness:** `Status.String()` implementation ([f81e205][100])
- **api/handlers/readiness:** `Status` enum ([c45a277][101])
- **sdk/api/response:** `LogEntry()` implementation ([c62180d][102])

### Documentation

- **build/just/podinfo:** `readiness-probe` recipe ([a989ce1][103])
- **api/handlers/readiness:** `HandlerFn` synopsis ([5b226c3][104])
- **api/handlers/readiness:** `handler.GetStatus()` synopsis ([7f85163][105])
- **api/handlers/readiness:** `handler.SetStatus()` synopsis ([db54578][106])
- **api/handlers/readiness:** `handler.SetLogger()` synopsis ([2ac7d67][107])
- **api/handlers/readiness:** `handler` struct synopsis ([14fcb57][108])
- **api/handlers/readiness:** `Response` struct synopsis ([7c7ecff][109])
- **api/handlers/readiness:** `Status.String()` synopsis ([777320c][110])
- **api/handlers/readiness:** `Status` enum ([9788dfb][111])
- **api/handlers/readiness:** package synopsis ([92c17f3][112])
- **sdk/api/response:** `LogEntry()` synopsis ([c9c5f7d][113])
- **changelog:** v0.2.0 ([c46195b][114])

### Refactors

- **api/handlers/liveness:** new pattern of writing `HandlerFn`
  ([d270881][115])
- **sdk/api/response:** `Write` function ([66fd066][116])
- **api/handlers/liveness:** change route impl pattern ([6efbf25][117])

### Build System

- **build/just/podinfo:** `readiness-probe` recipe ([14a6fe0][118])

### Chore

- **gitpod:** fix `gitpod` shell config in dockerfile ([ad05fc9][119])

### [v0.1.1][120] (2023-02-13)

#### Documentation

- **changelog:** `v0.1.0` ([e1bdb33][121])

#### Build System

- **just/git:** prune refs in `git-fetch` recipe ([69d5e05][122])

## [v0.1.0][123] (2023-02-13)

### Features

- **sdk/api/response:** `WriteJSON()` function implementation ([ac8c96c][124])
- **sdk/api/response:** `WriteSuccessfulJSONRaw()` function implementation
  ([f264be1][125])
- **api/handlers:** remove `Prefix` from pre-flight handler ([ae48e9d][126])
- **api/handlers:** Register and initialize `kubernetes-liveness-probe` route
  ([1c416f5][127])
- **api/handlers/liveness:** `Initialize()` function ([73548a0][128])
- **api/handlers/liveness:** `New()` function ([016f07c][129])
- **api/handlers/liveness:** `Handler` struct ([133a5a8][130])
- **api/handlers/liveness:** package constants ([a0b8f71][131])
- **api/handlers/liveness:** `Response` struct ([9bc1341][132])

### Bug Fixes

- **sdk/api/response:** address linter complaints ([a9eed4e][133])

### Documentation

- **docker/buildx:** `gitpod` target ([11b8055][134])
- `liveness-probe` instruction ([fc5852c][135])
- **sdk/api/response:** `WriteJSON()` function synopsis ([7e25e0a][136])
- **sdk/api/response:** `WriteSuccessfulJSONRaw()` synopsis ([63d16c4][137])
- **swaggger:** add `GET` verb for `/healthz` ([5a0bb54][138])
- fix instruction to run mage's `build` target ([d35f513][139])
- **api/handlers/liveness:** `Initialize()` function ([a8993b7][140])
- **api/handlers/liveness:** `New()` function ([add5240][141])
- **api/handlers/liveness:** `Handler` struct ([06f7e41][142])
- **api/handlers/liveness:** package constants ([0e5f809][143])
- **api/handlers/liveness:** `Status` enum ([2ac0c5e][144])
- **api/handlers/liveness:** package synopsis ([efe22ac][145])
- **changelog:** updated changelog for v0.0.1 ([533f465][146])

### Refactors

- **api/handlers/liveness:** update `handler()` to write response json without
  adding additional fields ([985c2cf][147])
...
- **go-releaser:** do not sign archive ([b931100][150])
- **docker:** `gitpod` target ([006af3c][151])
- **just/bootstrap:** add `rust` toolchain ([6d9e725][152])
- **docker:** laxer package versioning in dockerfile ([9db2bb8][153])
- **docker:** fixed minor issues with `docker-bake.hcl` file ([747b4f4][154])
- **just/bootstrap:** add `bootstrap-os-pkgs` dependency to `bootstrap` target
  ([c397414][155])
- **just/go:** fix `mage` install in `_build-go` target ([7a6a5d9][156])
- **just/commit:** fix `bootstrap-pre-commit` hook installation
  ([495f420][157])
- **just/semver:** changed changelog commit message pattern ([9a5964e][158])

### CI

- **docker:** detect `TAG` ([5ca9bde][159])
- **go:** add `go-releaser` step ([74090a2][160])
- **release:** fix deprecated flags in `go-releaser` step ([0c641be][161])
- update min go version to `1.20` ([385d829][162])
- **go:** fixed arguments in `test` step ([2e45224][163])
- **go:** fixed arguments in `build` step ([55e6ae7][164])
- **release:** remove `unshallow` step ([2011e4f][165])
- **release:** update `setup-go` and `goreleaser-action` actions
  ([ea4cc92][166])

### Chore

- **gitpod:** source `gitpod` variables ([168e63f][167])
- **gitpod:** `rust` toolchain configuration ([e3e3d0d][168])
- **gitpod:** add `bootstrap` task ([d2ce4f1][169])
- **gitpod:** added more tools to the dockerfile ([79f5f6d][170])
- minor fix ([f9bc049][171])
- minor fix ([9ae11b2][172])
- **pre-commit:** ensure Justfile is identical to upstream in `just-fmt.sh`
  script ([ee99516][173])
- **gitpod:** replace `yarn` with `npm` in Dockerfile ([927e64b][174])
- change image in `.gitpod.yml` ([f494de7][175])
- fix `.gitpod.yml` ([8c3577e][176])

### v0.0.1 (2023-02-12)

#### Features

- **api:** init ([3974f95][177])
- **api/core:** init ([891fa92][178])
- **api/errors:** init ([dc9c0cc][179])
- **api/handlers:** init ([a9354fe][180])
- **api/middlewares:** init ([03877c6][181])
- **api/registry:** init ([c093b2a][182])
- **cmd/podinfo:** init ([a3c1ebf][183])
- **internal/cryptoutil:** init ([34a4597][184])
- **internal/files:** init ([4ac385c][185])
- **internal/golang-lru:** init ([f1264aa][186])
- **internal/locksutil:** init ([09e59d1][187])
- **internal/logger:** init ([e066d10][188])
- **internal/multierror:** init ([a39b7c2][189])
- **internal/pathmanager:** init ([489996c][190])
- **internal/permitpool:** init ([a29c5d7][191])
- **internal/prettyprint:** init ([2bc4ce1][192])
- **internal/primitives:** init ([1a67ad6][193])
- **internal/runtimex:** init ([76eb234][194])
- **internal/testutils:** init ([c188be8][195])
- **internal/urandom:** init ([58ed4ff][196])
- **internal/version:** init ([4a98993][197])
- **sdk/physical:** init ([f8d487e][198])
- **internal/backoff/constant:** init ([f70b48d][199])
- **internal/backoff/exponential:** init ([437e93c][200])
- **internal/cli/data:** init ([9d115ad][201])
- **internal/cli/decoder:** init ([5b380a7][202])
- **internal/cli/flagset:** init ([a233141][203])
- **internal/cli/value:** init ([aef98ca][204])
- **internal/golang-lru/simplelru:** init ([8196569][205])
- **internal/logger/slack:** init ([1e97608][206])
- **internal/radix-tree/immutable:** init ([5dbb2e9][207])
- **internal/radix-tree/mutable:** init ([fade8c6][208])
- **sdk/api/address:** init ([69918d7][209])
- **sdk/api/fastjson:** init ([e5403e6][210])
- **sdk/api/metrics:** init ([fd5e5e2][211])
- **sdk/api/port:** init ([979298e][212])
- **sdk/api/proto:** init ([3ddbd38][213])
- **sdk/api/response:** init ([76ab9c8][214])
- **sdk/api/route:** init ([2a7f6c7][215])
- **sdk/physical/access:** init ([829e8ef][216])
- **sdk/physical/cache:** init ([48e7940][217])
- **sdk/physical/chroot:** init ([5eb4b18][218])
- **sdk/physical/encoding:** init ([b1895bf][219])
- **sdk/physical/error-injector:** init ([fa52696][220])
- **sdk/physical/latency:** init ([7d4928f][221])
- **sdk/physical/retry:** init ([8660a4d][222])
- **cmd/podinfo/commands/server:** init ([540b954][223])
- **cmd/podinfo/commands/version:** init ([df8d8d1][224])
- **docker/release:** minimal `Dockerfile` for the binary ([c4cd6da][225])

#### Documentation

- init ([93e80f2][226])
- **build/go:** `Build` target synopsis ([a9e2bfb][227])
- **just/podinfo:** `run` target synopsis ([966607f][228])
- **just/podinfo:** `kill` target synopsis ([d4bb819][229])
- **just/go:** `build-go` target synopsis ([89c2bae][230])
- **just/go:** `clean-go` target synopsis ([7089f0b][231])
- **just/go:** `lint-go` target synopsis ([25b8479][232])
- **just/go:** `format-go` target synopsis ([1c62db8][233])
- **just/go:** `bootstrap-go` target synopsis ([e37bcd0][234])
- **just/go:** `_build` target synopsis ([50231ce][235])
- **just/go:** `_go` target synopsis ([f240c28][236])
- **just/go:** `_lint-go` target synopsis ([5ac43ba][237])
- **just/semver:** `bootstrap-semver` target synopsis ([92ec6b4][238])
- **just/markdown:** `_format-markdown` target synopsis ([2721074][239])
- **just/justfile:** `format-just` target synopsis ([78a7965][240])
- **just/json:** `format-json` target synopsis ([8c5778c][241])
- **just/json:** `_format-json` target synopsis ([6a417bd][242])
- **just/bash:** `lint-bash` target synopsis ([2e74c8d][243])
- **just/bash:** `format-bash` target synopsis ([b59a5d7][244])
- **just/bash:** `_lint-bash` target synopsis ([08b1ac6][245])
- **just/bash:** `_format-bash` target synopsis ([ef340bb][246])
- **just/misc:** `snapshot` target synopsis ([4026b9e][247])
- **just/misc:** `vscode-tasks` target synopsis ([deb5e1d][248])
- **just/semver:** `generate-changelog` target synopsis ([aa5683b][249])
- **just/semver:** `patch-release` target synopsis ([74afa35][250])
- **just/semver:** `minor-release` target synopsis ([2bde4d8][251])
- **just/semver:** `major-release` target synopsis ([03bb13d][252])
- **just/semver:** variable synopsis ([a5db8af][253])
- **just/commit:** `commit` target synopsis ([d02b807][254])
- **just/commit:** `bootstrap-pre-commit` target synopsis ([c367eae][255])
- **just/commit:** `_pre-commit` target synopsis ([6aee1b8][256])
- **just/git:** `git-add` target synopsis ([f84a9eb][257])
- **just/git:** `_git-delta` target synopsis ([3781d54][258])
- **just/git:** `_git-delta` target synopsis ([b8d961d][259])
- **just/bootstrap:** `_update-rust` target synopsis ([0d1588e][260])
- **just/bootstrap:** `_validate-rust` target synopsis ([b223255][261])
- **just/bootstrap:** `_install-nodejs-package` target synopsis
  ([58aabd6][262])
- **just/bootstrap:** `_bootstrap-nodejs` target synopsis ([00df92c][263])
- **just/bootstrap:** `_core-pkgs` target synopsis ([9a78d0a][264])
- **just/bootstrap:** `_install-os-package` target synopsis ([b817954][265])
- **just/bootstrap:** `_update-os-pkgs` target synopsis ([4b94227][266])
- **just/bootstrap:** `kary-comments` target synopsis ([f80992f][267])
- **just:** common variables ([9cc3843][268])
- **build/go/targets/test:** `Target` function synopsis ([7a17aad][269])
- **build/go/targets:** package synopsis ([40e593d][270])
- **build/go/targets/test:** package synopsis ([7e5375b][271])
- **build/go/targets/build:** package synopsis ([960062d][272])
- **build/go/git:** package synopsis ([2a1ffd4][273])
- **build/go/version:** package synopsis ([265da8c][274])
- **api:** synopsis ([295aad0][275])
- **sdk:** synopsis ([9f0d098][276])
- **api/core:** synopsis ([9ef7b34][277])
- **api/handlers:** synopsis ([b0e0874][278])
- **api/middlewares:** synopsis ([d3233c8][279])
- **api/registry:** synopsis ([e801ead][280])
- **internal/files:** synopsis ([a163f57][281])
- **internal/golang-lru:** synopsis ([d63c0a7][282])
- **internal/logger:** synopsis ([5d65330][283])
- **internal/permitpool:** synopsis ([41feade][284])
- **internal/prettyprint:** synopsis ([87c51ba][285])
- **internal/primitives:** synopsis ([8a083ac][286])
- **internal/runtimex:** synopsis ([dffbbdc][287])
- **internal/testutils:** synopsis ([3895ee7][288])
- **internal/urandom:** synopsis ([ab5c0b9][289])
- **sdk/api:** synopsis ([f657f44][290])
- **sdk/physical:** synopsis ([9706c76][291])
- **cmd/podinfo/commands:** synopsis ([108d9eb][292])
- **internal/cli/data:** synopsis ([3574a9c][293])
- **internal/cli/decoder:** synopsis ([a13ad40][294])
- **internal/cli/flagset:** synopsis ([0a9d0c1][295])
- **internal/logger/slack:** synopsis ([83a078c][296])
- **internal/radix-tree/immutable:** synopsis ([78abe82][297])
- **internal/radix-tree/mutable:** synopsis ([4e53b91][298])
- **sdk/api/address:** synopsis ([23ab44b][299])
- **sdk/api/fastjson:** synopsis ([2a7c790][300])
- **sdk/api/metrics:** synopsis ([c505728][301])
- **sdk/api/port:** synopsis ([1090e11][302])
- **sdk/api/proto:** synopsis ([197fad7][303])
- **sdk/api/response:** synopsis ([5cdbfab][304])
- **sdk/api/route:** synopsis ([6d23ed6][305])
- **sdk/physical/access:** synopsis ([cea7bee][306])
- **sdk/physical/cache:** synopsis ([13e7f7d][307])
- **sdk/physical/chroot:** synopsis ([4b31bb4][308])
- **sdk/physical/encoding:** synopsis ([49a1e33][309])
- **sdk/physical/error-injector:** synopsis ([70446b1][310])
- **sdk/physical/latency:** synopsis ([1f906c5][311])
- **sdk/physical/retry:** synopsis ([13983aa][312])
- **cmd/podinfo/commands/server:** synopsis ([942978f][313])
- **cmd/podinfo/commands/version:** synopsis ([26ea212][314])
- **docker-bake:** usage guide ([5344b78][315])
- **docker-bake:** `release` target synopsis ([e55beca][316])
- **docker-bake:** `default` group synopsis ([baf2270][317])
- **docker-bake:** `TAG` variable synopsis ([abe018f][318])
- **docker-bake:** `AMD64` variable synopsis ([7909900][319])
- **docker-bake:** `ARM64` variable synopsis ([750e36d][320])
- **docker-bake:** `REGISTRY_USERNAME` variable synopsis ([4c68a04][321])
- **docker-bake:** `REGISTRY_HOSTNAME` variable synopsis ([83e5534][322])
- **docker-bake:** `LOCAL` variable synopsis ([e238d0e][323])
- **github:** `programming_task` issue template ([dba5a78][324])
- **github:** `feature_request` issue template ([4124f12][325])
- **github:** `bug_report` issue template ([c7d8513][326])
- **github:** `api_endpoint_spec` issue template ([d60a2a9][327])

#### Refactors

- **mage:** remove old files ([eabe9ea][328])

#### Tests

- **api/core:** init ([0598dda][329])
- **internal/files:** init ([ffb9e6b][330])
- **internal/logger:** init ([1d6b435][331])
- **internal/primitives:** init ([b3ebabc][332])
- **internal/backoff/constant:** init ([c3255c2][333])
- **internal/backoff/exponential:** init ([588c83a][334])
- **internal/cli/decoder:** init ([1b3cfbe][335])
- **internal/cli/value:** init ([4aeaebb][336])
- **sdk/api/fastjson:** init ([01cd7be][337])

#### Build System

- **just/core:** aggregator targets ([3382f77][338])
- **just/podinfo:** `run` target implementation ([e262bfa][339])
- **just/podinfo:** `kill` target implementation ([40a0637][340])
- **just/go:** `build-go` target implementation ([d8670aa][341])
- **just/go:** `clean-go` target implementation ([8dc7e7c][342])
- **just/go:** `lint-go` target implementation ([14209fd][343])
- **just/go:** `format-go` target implementation ([0126826][344])
- **just/go:** `bootstrap-go` target implementation ([39b68ce][345])
- **just/go:** `_build` hidden target implementation ([47dc4e8][346])
- **just/go:** `_go` hidden target implementation ([26a247a][347])
- **just/go:** `_lint-go` hidden target implementation ([351a32a][348])
- **just/semver:** `bootstrap-semver` target implementation ([3ca58f4][349])
- **just/markdown:** `_format-markdown` hidden target implementation
  ([852e53e][350])
- **just/justfile:** `format-just` target implementation ([eb8efa2][351])
- **just/json:** `format-json` target implementation ([e540c34][352])
- **just/json:** `_format-json` hidden target implementation ([2754846][353])
- **just/bash:** `lint-bash` target implementation ([5cfd1f9][354])
- **just/bash:** `format-bash` target implementation ([05d97b0][355])
- **just/bash:** `_lint-bash` hidden target implementation ([2e56839][356])
- **just/bash:** `_format-bash` hidden target implementation ([2214242][357])
- **just/misc:** `snapshot` target implementation ([184f86e][358])
- **just/misc:** `vscode-tasks` target implementation ([8669e48][359])
- **just/semver:** `generate-changelog` target implementation ([d9813b6][360])
- **just/semver:** `patch-release` target implementation ([0ee99d8][361])
- **just/semver:** `minor-release` target implementation ([47c8d9d][362])
- **just/semver:** `major-release` target implementation ([4ca9c5c][363])
- **just/semver:** variable declaration ([fb9c78a][364])
- **just/commit:** `commit` target implementation ([f574bf3][365])
- **just/commit:** `bootstrap-pre-commit` target implementation
  ([1243472][366])
- **just/git:** `_pre-commit` hidden target implementation ([e5c5206][367])
- **just/git:** `git-add` target implementation ([b053a64][368])
- **just/git:** `git-fetch` target implementation ([28764fb][369])
- **just/git:** `_git-delta` hidden target implementation ([33b956f][370])
...
- **just/bootstrap:** `_update-os-pkgs` hidden target implementation
  ([7fb7d14][378])
- **just/bootstrap:** `kary-comments` target implementation ([8ffe083][379])
- **just:** common config ([86033e0][380])
- **go:** moved from `magefile.go` ([52e7886][381])
- **go/targets/test:** moved from `mage/test` ([84ef4a7][382])
- **go/targets/build:** moved from `mage/build` ([a07a063][383])
- **go/git:** moved from `mage/git` ([ae05d7a][384])
- **go/version:** moved from `internal/version` ([1906bdc][385])
- **docker-bake:** `release` target implementation ([778b6f7][386])
- **docker-bake:** `TAG` variable declaration ([dd58811][387])
- **docker-bake:** `AMD64` variable declaration ([763dcb7][388])
- **docker-bake:** `ARM64` variable declaration ([7feeae8][389])
- **docker-bake:** `REGISTRY_USERNAME` variable declaration ([c0493f8][390])
- **docker-bake:** `REGISTRY_HOSTNAME` variable declaration ([0cebd31][391])
- **docker-bake:** `LOCAL` variable declaration ([a89e0be][392])
- **docker/release:** added buildx installer/setup to the script
  ([607964a][393])
- **docker/release:** multi-arch builder script ([2d320e6][394])
- `go-releaser` config ([25bea21][395])
- **mage:** `magefile` init ([2e7af35][396])
- **test:** `test` mage targets ([84e27ca][397])
- **build:** `build` mage targets ([5471c34][398])
- **git:** `git` auxiliary library ([4908743][399])

#### CI

- **github:** `release` workflow ([fc1e8f4][400])
- **github:** `go` workflow ([299d59e][401])
- **github:** `docker` workflow ([4e9b676][402])

#### Chore

- **pre-commit:** `just-fmt` pre-commit hook ([57b16f2][403])
- **pre-commit:** `md-fmt` pre-commit hook ([8c4b6c4][404])
- **docs:** fix `markdown` file exception `.gitignore` ([b501fa4][405])
- **build:** local `.gitignore` ([755f5d2][406])
- **internal:** local `.gitignore` ([825e7c2][407])
- **sdk:** local `.gitignore` ([f55402b][408])
- **cmd:** local `.gitignore` ([6ff23fe][409])
- **api:** local `.gitignore` ([a160290][410])
- **docs:** local `.gitignore` ([fbfd5b7][411])
- **assets:** local `.gitignore` ([502e7a5][412])
- **fixtures:** local `.gitignore` ([7a098f4][413])
- simplify `.editorconfig` file ([b61d49c][414])
- fixed `.editorconfig` file ([a8db8f7][415])
- **pre-commit:** `go-mod-tidy` pre-commit hook ([713d5ab][416])
- **pre-commit:** `go-fmt` pre-commit hook ([2fbb351][417])
- **github:** `CODEOWNERS` file ([7d5618d][418])
- **vscode:** `tasks` configuration file ([8d9e1cd][419])
- **vscode:** `settings` configuration file ([3ec3faf][420])
- **vscode:** `launch` configuration file ([7ab2d30][421])
- **vscode:** `extensions` configuration file ([2f05faf][422])
- `gitpod` config ([6aeea05][423])
- go vendor dependency management with `tools.go` ([82fea78][424])
- `.env` file init ([24c7238][425])
- `pre-commit` config file ([3d8d786][426])
- **linter:** `cspell` golang dictionary ([7b20441][427])
- **linter:** `cspell` generic dictionary ([b95cfbe][428])
- **linter:** `cspell` config file ([63d43ce][429])
- **linter:** `golangci` config file ([87a9658][430])
- **linter:** `revive` config file ([40abb30][431])
- **linter:** `.markdownlintignore` file ([eb1bae8][432])
- `.versionrc` file ([bee9668][433])
- `.stignore` file ([5bb284d][434])
- `.editorconfig` file ([640d343][435])
- `.dockerignore` file ([aabfa50][436])
- `gitignore` file ([8c88606][437])
- **linter:** `commitlint` config ([4f34502][438])

[1]: https://github.com/da-moon/northern-labs-interview/compare/v0.7.0...v0.8.0
[2]:
...
[7]: https://github.com/da-moon/northern-labs-interview/compare/v0.6.3...v0.7.0
[8]:
