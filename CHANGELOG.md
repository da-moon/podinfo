...
- **api/handlers:** register **GET** `/delay/{seconds}` route in `Initialize()`
  ([5a9dc8e][2])
- **api/handlers/delay:** route `register` implementation ([f39830b][3])
- **api/handlers/delay:** `handler` implementation ([bf469a3][4])
- **api/handlers/delay:** `response` setup ([d22dc78][5])

### Documentation

- **api/handlers/delay:** package synopsis ([e260245][6])
- **changelog:** v0.4.0 ([d7d5af7][7])

### Build System

- **build/just/podinfo:** `delay-probe` recipe ([9d0b55f][8])

## [v0.4.0][9] (2023-02-15)

### Features

- **api/handlers:** register `/headers` route in `Initialize()` ([10cef5d][10])
- **api/handlers/headers:** route `register` implementation ([989f948][11])
- **api/handlers/headers:** `handler` implementation ([9871e64][12])
- **api/handlers/headers:** `response` type ([019355e][13])

### Documentation

- **api/handlers/headers:** package synopsis ([489218a][14])

### Build System

- **build/just/podinfo:** `headers-probe` recipe ([239a061][15])

## [v0.3.0][16] (2023-02-15)

### Features

- **api/handlers:** register `/env` route in `Initialize()` ([2d98b6a][17])
- **api/handlers/env:** routte `register` implementation ([958bc47][18])
- **api/handlers/env:** `handler` implementation ([0ef5a8f][19])
- **api/handlers/env:** `response` type ([877b7e4][20])

### Documentation

- **api/handlers/env:** package synopsis ([edc489e][21])

### Build System

- **build/just/podinfo:** `env-probe` recipe ([b66f28b][22])

### [v0.2.2][23] (2023-02-15)

#### Features

- **api/handlers:** register `/readyz/enable` route in `Initialize()`
  ([dead392][24])
- **api/handlers/readiness/enable:** route init ([b56a400][25])
- **api/handlers/readiness/enable:** handler setup ([9356de0][26])

#### Documentation

- **api/handlers/readiness/enable:** package synopsis ([faeaf50][27])

#### Build System

- **build/just/podinfo:** `readiness-probe-enable` recipe ([65c6272][28])

### [v0.2.1][29] (2023-02-15)

#### Features

- **api/handlers:** register the route in `Initialize()` ([ae99b84][30])
...
- **api/handlers/readiness/disable:** `HandlerFn` synopsis ([ac1c0ee][38])
- **api/handlers/readiness/disable:** `handler` struct synopsis ([5e8ae1e][39])
- **api/handlers/readiness/disable:** package synopsis ([4753ee2][40])
- **changelog:** v0.2.0 ([2ec37fc][41])

#### Build System

- **build/just/podinfo:** `readiness-probe-disable` recipe ([f0efeb5][42])

## [v0.2.0][43] (2023-02-15)

### Features

- **api/handlers/readiness:** `handler.Register()` implementation
  ([229f6ef][44])
- **api/handlers/readiness:** `init()` implementation ([316c88d][45])
- **api/handlers/readiness:** `HandlerFn` implementation ([fa4e4e0][46])
- **api/handlers/readiness:** `handler.GetStatus()` implementation
  ([6975ceb][47])
- **api/handlers/readiness:** `handler.SetStatus()` implementation
  ([0ae4c75][48])
- **api/handlers/readiness:** `handler.GetLogger()` synopsis ([1fb4903][49])
- **api/handlers/readiness:** `handler.GetLogger()` implementation
  ([2af2f25][50])
- **api/handlers/readiness:** `handler.SetLogger()` implementation
  ([a34f22d][51])
- **api/handlers/readiness:** `handler` struct implementation ([4a73558][52])
- **api/handlers/readiness:** `Response` struct implementation ([8ea8855][53])
- **api/handlers/readiness:** `Status.String()` implementation ([f81e205][54])
- **api/handlers/readiness:** `Status` enum ([c45a277][55])
- **sdk/api/response:** `LogEntry()` implementation ([c62180d][56])

### Documentation

- **build/just/podinfo:** `readiness-probe` recipe ([a989ce1][57])
- **api/handlers/readiness:** `HandlerFn` synopsis ([5b226c3][58])
- **api/handlers/readiness:** `handler.GetStatus()` synopsis ([7f85163][59])
- **api/handlers/readiness:** `handler.SetStatus()` synopsis ([db54578][60])
- **api/handlers/readiness:** `handler.SetLogger()` synopsis ([2ac7d67][61])
- **api/handlers/readiness:** `handler` struct synopsis ([14fcb57][62])
- **api/handlers/readiness:** `Response` struct synopsis ([7c7ecff][63])
- **api/handlers/readiness:** `Status.String()` synopsis ([777320c][64])
- **api/handlers/readiness:** `Status` enum ([9788dfb][65])
- **api/handlers/readiness:** package synopsis ([92c17f3][66])
- **sdk/api/response:** `LogEntry()` synopsis ([c9c5f7d][67])
- **changelog:** v0.2.0 ([c46195b][68])

### Refactors

- **api/handlers/liveness:** new pattern of writing `HandlerFn` ([d270881][69])
- **sdk/api/response:** `Write` function ([66fd066][70])
- **api/handlers/liveness:** change route impl pattern ([6efbf25][71])

### Build System

- **build/just/podinfo:** `readiness-probe` recipe ([14a6fe0][72])

### Chore

- **gitpod:** fix `gitpod` shell config in dockerfile ([ad05fc9][73])

### [v0.1.1][74] (2023-02-13)

#### Documentation

- **changelog:** `v0.1.0` ([e1bdb33][75])

#### Build System

- **just/git:** prune refs in `git-fetch` recipe ([69d5e05][76])

## [v0.1.0][77] (2023-02-13)

### Features

- **sdk/api/response:** `WriteJSON()` function implementation ([ac8c96c][78])
- **sdk/api/response:** `WriteSuccessfulJSONRaw()` function implementation
  ([f264be1][79])
- **api/handlers:** remove `Prefix` from pre-flight handler ([ae48e9d][80])
- **api/handlers:** Register and initialize `kubernetes-liveness-probe` route
  ([1c416f5][81])
- **api/handlers/liveness:** `Initialize()` function ([73548a0][82])
- **api/handlers/liveness:** `New()` function ([016f07c][83])
- **api/handlers/liveness:** `Handler` struct ([133a5a8][84])
- **api/handlers/liveness:** package constants ([a0b8f71][85])
- **api/handlers/liveness:** `Response` struct ([9bc1341][86])

### Bug Fixes

- **sdk/api/response:** address linter complaints ([a9eed4e][87])

### Documentation

- **docker/buildx:** `gitpod` target ([11b8055][88])
- `liveness-probe` instruction ([fc5852c][89])
- **sdk/api/response:** `WriteJSON()` function synopsis ([7e25e0a][90])
- **sdk/api/response:** `WriteSuccessfulJSONRaw()` synopsis ([63d16c4][91])
- **swaggger:** add `GET` verb for `/healthz` ([5a0bb54][92])
- fix instruction to run mage's `build` target ([d35f513][93])
- **api/handlers/liveness:** `Initialize()` function ([a8993b7][94])
- **api/handlers/liveness:** `New()` function ([add5240][95])
- **api/handlers/liveness:** `Handler` struct ([06f7e41][96])
- **api/handlers/liveness:** package constants ([0e5f809][97])
- **api/handlers/liveness:** `Status` enum ([2ac0c5e][98])
- **api/handlers/liveness:** package synopsis ([efe22ac][99])
- **changelog:** updated changelog for v0.0.1 ([533f465][100])

### Refactors

- **api/handlers/liveness:** update `handler()` to write response json without
  adding additional fields ([985c2cf][101])
...
- **go-releaser:** do not sign archive ([b931100][104])
- **docker:** `gitpod` target ([006af3c][105])
- **just/bootstrap:** add `rust` toolchain ([6d9e725][106])
- **docker:** laxer package versioning in dockerfile ([9db2bb8][107])
- **docker:** fixed minor issues with `docker-bake.hcl` file ([747b4f4][108])
- **just/bootstrap:** add `bootstrap-os-pkgs` dependency to `bootstrap` target
  ([c397414][109])
- **just/go:** fix `mage` install in `_build-go` target ([7a6a5d9][110])
- **just/commit:** fix `bootstrap-pre-commit` hook installation
  ([495f420][111])
- **just/semver:** changed changelog commit message pattern ([9a5964e][112])

### CI

- **docker:** detect `TAG` ([5ca9bde][113])
- **go:** add `go-releaser` step ([74090a2][114])
- **release:** fix deprecated flags in `go-releaser` step ([0c641be][115])
- update min go version to `1.20` ([385d829][116])
- **go:** fixed arguments in `test` step ([2e45224][117])
- **go:** fixed arguments in `build` step ([55e6ae7][118])
- **release:** remove `unshallow` step ([2011e4f][119])
- **release:** update `setup-go` and `goreleaser-action` actions
  ([ea4cc92][120])

### Chore

- **gitpod:** source `gitpod` variables ([168e63f][121])
- **gitpod:** `rust` toolchain configuration ([e3e3d0d][122])
- **gitpod:** add `bootstrap` task ([d2ce4f1][123])
- **gitpod:** added more tools to the dockerfile ([79f5f6d][124])
- minor fix ([f9bc049][125])
- minor fix ([9ae11b2][126])
- **pre-commit:** ensure Justfile is identical to upstream in `just-fmt.sh`
  script ([ee99516][127])
- **gitpod:** replace `yarn` with `npm` in Dockerfile ([927e64b][128])
- change image in `.gitpod.yml` ([f494de7][129])
- fix `.gitpod.yml` ([8c3577e][130])

### v0.0.1 (2023-02-12)

#### Features

- **api:** init ([3974f95][131])
- **api/core:** init ([891fa92][132])
- **api/errors:** init ([dc9c0cc][133])
- **api/handlers:** init ([a9354fe][134])
- **api/middlewares:** init ([03877c6][135])
- **api/registry:** init ([c093b2a][136])
- **cmd/podinfo:** init ([a3c1ebf][137])
- **internal/cryptoutil:** init ([34a4597][138])
- **internal/files:** init ([4ac385c][139])
- **internal/golang-lru:** init ([f1264aa][140])
- **internal/locksutil:** init ([09e59d1][141])
- **internal/logger:** init ([e066d10][142])
- **internal/multierror:** init ([a39b7c2][143])
- **internal/pathmanager:** init ([489996c][144])
- **internal/permitpool:** init ([a29c5d7][145])
- **internal/prettyprint:** init ([2bc4ce1][146])
- **internal/primitives:** init ([1a67ad6][147])
- **internal/runtimex:** init ([76eb234][148])
- **internal/testutils:** init ([c188be8][149])
- **internal/urandom:** init ([58ed4ff][150])
- **internal/version:** init ([4a98993][151])
- **sdk/physical:** init ([f8d487e][152])
- **internal/backoff/constant:** init ([f70b48d][153])
- **internal/backoff/exponential:** init ([437e93c][154])
- **internal/cli/data:** init ([9d115ad][155])
- **internal/cli/decoder:** init ([5b380a7][156])
- **internal/cli/flagset:** init ([a233141][157])
- **internal/cli/value:** init ([aef98ca][158])
- **internal/golang-lru/simplelru:** init ([8196569][159])
- **internal/logger/slack:** init ([1e97608][160])
- **internal/radix-tree/immutable:** init ([5dbb2e9][161])
- **internal/radix-tree/mutable:** init ([fade8c6][162])
- **sdk/api/address:** init ([69918d7][163])
- **sdk/api/fastjson:** init ([e5403e6][164])
- **sdk/api/metrics:** init ([fd5e5e2][165])
- **sdk/api/port:** init ([979298e][166])
- **sdk/api/proto:** init ([3ddbd38][167])
- **sdk/api/response:** init ([76ab9c8][168])
- **sdk/api/route:** init ([2a7f6c7][169])
- **sdk/physical/access:** init ([829e8ef][170])
- **sdk/physical/cache:** init ([48e7940][171])
- **sdk/physical/chroot:** init ([5eb4b18][172])
- **sdk/physical/encoding:** init ([b1895bf][173])
- **sdk/physical/error-injector:** init ([fa52696][174])
- **sdk/physical/latency:** init ([7d4928f][175])
- **sdk/physical/retry:** init ([8660a4d][176])
- **cmd/podinfo/commands/server:** init ([540b954][177])
- **cmd/podinfo/commands/version:** init ([df8d8d1][178])
- **docker/release:** minimal `Dockerfile` for the binary ([c4cd6da][179])

#### Documentation

- init ([93e80f2][180])
- **build/go:** `Build` target synopsis ([a9e2bfb][181])
- **just/podinfo:** `run` target synopsis ([966607f][182])
- **just/podinfo:** `kill` target synopsis ([d4bb819][183])
- **just/go:** `build-go` target synopsis ([89c2bae][184])
- **just/go:** `clean-go` target synopsis ([7089f0b][185])
- **just/go:** `lint-go` target synopsis ([25b8479][186])
- **just/go:** `format-go` target synopsis ([1c62db8][187])
- **just/go:** `bootstrap-go` target synopsis ([e37bcd0][188])
- **just/go:** `_build` target synopsis ([50231ce][189])
- **just/go:** `_go` target synopsis ([f240c28][190])
- **just/go:** `_lint-go` target synopsis ([5ac43ba][191])
- **just/semver:** `bootstrap-semver` target synopsis ([92ec6b4][192])
- **just/markdown:** `_format-markdown` target synopsis ([2721074][193])
- **just/justfile:** `format-just` target synopsis ([78a7965][194])
- **just/json:** `format-json` target synopsis ([8c5778c][195])
- **just/json:** `_format-json` target synopsis ([6a417bd][196])
- **just/bash:** `lint-bash` target synopsis ([2e74c8d][197])
- **just/bash:** `format-bash` target synopsis ([b59a5d7][198])
- **just/bash:** `_lint-bash` target synopsis ([08b1ac6][199])
- **just/bash:** `_format-bash` target synopsis ([ef340bb][200])
- **just/misc:** `snapshot` target synopsis ([4026b9e][201])
- **just/misc:** `vscode-tasks` target synopsis ([deb5e1d][202])
- **just/semver:** `generate-changelog` target synopsis ([aa5683b][203])
- **just/semver:** `patch-release` target synopsis ([74afa35][204])
- **just/semver:** `minor-release` target synopsis ([2bde4d8][205])
- **just/semver:** `major-release` target synopsis ([03bb13d][206])
- **just/semver:** variable synopsis ([a5db8af][207])
- **just/commit:** `commit` target synopsis ([d02b807][208])
- **just/commit:** `bootstrap-pre-commit` target synopsis ([c367eae][209])
- **just/commit:** `_pre-commit` target synopsis ([6aee1b8][210])
- **just/git:** `git-add` target synopsis ([f84a9eb][211])
- **just/git:** `_git-delta` target synopsis ([3781d54][212])
- **just/git:** `_git-delta` target synopsis ([b8d961d][213])
- **just/bootstrap:** `_update-rust` target synopsis ([0d1588e][214])
- **just/bootstrap:** `_validate-rust` target synopsis ([b223255][215])
- **just/bootstrap:** `_install-nodejs-package` target synopsis
  ([58aabd6][216])
- **just/bootstrap:** `_bootstrap-nodejs` target synopsis ([00df92c][217])
- **just/bootstrap:** `_core-pkgs` target synopsis ([9a78d0a][218])
- **just/bootstrap:** `_install-os-package` target synopsis ([b817954][219])
- **just/bootstrap:** `_update-os-pkgs` target synopsis ([4b94227][220])
- **just/bootstrap:** `kary-comments` target synopsis ([f80992f][221])
- **just:** common variables ([9cc3843][222])
- **build/go/targets/test:** `Target` function synopsis ([7a17aad][223])
- **build/go/targets:** package synopsis ([40e593d][224])
- **build/go/targets/test:** package synopsis ([7e5375b][225])
- **build/go/targets/build:** package synopsis ([960062d][226])
- **build/go/git:** package synopsis ([2a1ffd4][227])
- **build/go/version:** package synopsis ([265da8c][228])
- **api:** synopsis ([295aad0][229])
- **sdk:** synopsis ([9f0d098][230])
- **api/core:** synopsis ([9ef7b34][231])
- **api/handlers:** synopsis ([b0e0874][232])
- **api/middlewares:** synopsis ([d3233c8][233])
- **api/registry:** synopsis ([e801ead][234])
- **internal/files:** synopsis ([a163f57][235])
- **internal/golang-lru:** synopsis ([d63c0a7][236])
- **internal/logger:** synopsis ([5d65330][237])
- **internal/permitpool:** synopsis ([41feade][238])
- **internal/prettyprint:** synopsis ([87c51ba][239])
- **internal/primitives:** synopsis ([8a083ac][240])
- **internal/runtimex:** synopsis ([dffbbdc][241])
- **internal/testutils:** synopsis ([3895ee7][242])
- **internal/urandom:** synopsis ([ab5c0b9][243])
- **sdk/api:** synopsis ([f657f44][244])
- **sdk/physical:** synopsis ([9706c76][245])
- **cmd/podinfo/commands:** synopsis ([108d9eb][246])
- **internal/cli/data:** synopsis ([3574a9c][247])
- **internal/cli/decoder:** synopsis ([a13ad40][248])
- **internal/cli/flagset:** synopsis ([0a9d0c1][249])
- **internal/logger/slack:** synopsis ([83a078c][250])
- **internal/radix-tree/immutable:** synopsis ([78abe82][251])
- **internal/radix-tree/mutable:** synopsis ([4e53b91][252])
- **sdk/api/address:** synopsis ([23ab44b][253])
- **sdk/api/fastjson:** synopsis ([2a7c790][254])
- **sdk/api/metrics:** synopsis ([c505728][255])
- **sdk/api/port:** synopsis ([1090e11][256])
- **sdk/api/proto:** synopsis ([197fad7][257])
- **sdk/api/response:** synopsis ([5cdbfab][258])
- **sdk/api/route:** synopsis ([6d23ed6][259])
- **sdk/physical/access:** synopsis ([cea7bee][260])
- **sdk/physical/cache:** synopsis ([13e7f7d][261])
- **sdk/physical/chroot:** synopsis ([4b31bb4][262])
- **sdk/physical/encoding:** synopsis ([49a1e33][263])
- **sdk/physical/error-injector:** synopsis ([70446b1][264])
- **sdk/physical/latency:** synopsis ([1f906c5][265])
- **sdk/physical/retry:** synopsis ([13983aa][266])
- **cmd/podinfo/commands/server:** synopsis ([942978f][267])
- **cmd/podinfo/commands/version:** synopsis ([26ea212][268])
- **docker-bake:** usage guide ([5344b78][269])
- **docker-bake:** `release` target synopsis ([e55beca][270])
- **docker-bake:** `default` group synopsis ([baf2270][271])
- **docker-bake:** `TAG` variable synopsis ([abe018f][272])
- **docker-bake:** `AMD64` variable synopsis ([7909900][273])
- **docker-bake:** `ARM64` variable synopsis ([750e36d][274])
- **docker-bake:** `REGISTRY_USERNAME` variable synopsis ([4c68a04][275])
- **docker-bake:** `REGISTRY_HOSTNAME` variable synopsis ([83e5534][276])
- **docker-bake:** `LOCAL` variable synopsis ([e238d0e][277])
- **github:** `programming_task` issue template ([dba5a78][278])
- **github:** `feature_request` issue template ([4124f12][279])
- **github:** `bug_report` issue template ([c7d8513][280])
- **github:** `api_endpoint_spec` issue template ([d60a2a9][281])

#### Refactors

- **mage:** remove old files ([eabe9ea][282])

#### Tests

- **api/core:** init ([0598dda][283])
- **internal/files:** init ([ffb9e6b][284])
- **internal/logger:** init ([1d6b435][285])
- **internal/primitives:** init ([b3ebabc][286])
- **internal/backoff/constant:** init ([c3255c2][287])
- **internal/backoff/exponential:** init ([588c83a][288])
- **internal/cli/decoder:** init ([1b3cfbe][289])
- **internal/cli/value:** init ([4aeaebb][290])
- **sdk/api/fastjson:** init ([01cd7be][291])

#### Build System

- **just/core:** aggregator targets ([3382f77][292])
- **just/podinfo:** `run` target implementation ([e262bfa][293])
- **just/podinfo:** `kill` target implementation ([40a0637][294])
- **just/go:** `build-go` target implementation ([d8670aa][295])
- **just/go:** `clean-go` target implementation ([8dc7e7c][296])
- **just/go:** `lint-go` target implementation ([14209fd][297])
- **just/go:** `format-go` target implementation ([0126826][298])
- **just/go:** `bootstrap-go` target implementation ([39b68ce][299])
- **just/go:** `_build` hidden target implementation ([47dc4e8][300])
- **just/go:** `_go` hidden target implementation ([26a247a][301])
- **just/go:** `_lint-go` hidden target implementation ([351a32a][302])
- **just/semver:** `bootstrap-semver` target implementation ([3ca58f4][303])
- **just/markdown:** `_format-markdown` hidden target implementation
  ([852e53e][304])
- **just/justfile:** `format-just` target implementation ([eb8efa2][305])
- **just/json:** `format-json` target implementation ([e540c34][306])
- **just/json:** `_format-json` hidden target implementation ([2754846][307])
- **just/bash:** `lint-bash` target implementation ([5cfd1f9][308])
- **just/bash:** `format-bash` target implementation ([05d97b0][309])
- **just/bash:** `_lint-bash` hidden target implementation ([2e56839][310])
- **just/bash:** `_format-bash` hidden target implementation ([2214242][311])
- **just/misc:** `snapshot` target implementation ([184f86e][312])
- **just/misc:** `vscode-tasks` target implementation ([8669e48][313])
- **just/semver:** `generate-changelog` target implementation ([d9813b6][314])
- **just/semver:** `patch-release` target implementation ([0ee99d8][315])
- **just/semver:** `minor-release` target implementation ([47c8d9d][316])
- **just/semver:** `major-release` target implementation ([4ca9c5c][317])
- **just/semver:** variable declaration ([fb9c78a][318])
- **just/commit:** `commit` target implementation ([f574bf3][319])
- **just/commit:** `bootstrap-pre-commit` target implementation
  ([1243472][320])
- **just/git:** `_pre-commit` hidden target implementation ([e5c5206][321])
- **just/git:** `git-add` target implementation ([b053a64][322])
- **just/git:** `git-fetch` target implementation ([28764fb][323])
- **just/git:** `_git-delta` hidden target implementation ([33b956f][324])
...
- **just/bootstrap:** `_update-os-pkgs` hidden target implementation
  ([7fb7d14][332])
- **just/bootstrap:** `kary-comments` target implementation ([8ffe083][333])
- **just:** common config ([86033e0][334])
- **go:** moved from `magefile.go` ([52e7886][335])
- **go/targets/test:** moved from `mage/test` ([84ef4a7][336])
- **go/targets/build:** moved from `mage/build` ([a07a063][337])
- **go/git:** moved from `mage/git` ([ae05d7a][338])
- **go/version:** moved from `internal/version` ([1906bdc][339])
- **docker-bake:** `release` target implementation ([778b6f7][340])
- **docker-bake:** `TAG` variable declaration ([dd58811][341])
- **docker-bake:** `AMD64` variable declaration ([763dcb7][342])
- **docker-bake:** `ARM64` variable declaration ([7feeae8][343])
- **docker-bake:** `REGISTRY_USERNAME` variable declaration ([c0493f8][344])
- **docker-bake:** `REGISTRY_HOSTNAME` variable declaration ([0cebd31][345])
- **docker-bake:** `LOCAL` variable declaration ([a89e0be][346])
- **docker/release:** added buildx installer/setup to the script
  ([607964a][347])
- **docker/release:** multi-arch builder script ([2d320e6][348])
- `go-releaser` config ([25bea21][349])
- **mage:** `magefile` init ([2e7af35][350])
- **test:** `test` mage targets ([84e27ca][351])
- **build:** `build` mage targets ([5471c34][352])
- **git:** `git` auxiliary library ([4908743][353])

#### CI

- **github:** `release` workflow ([fc1e8f4][354])
- **github:** `go` workflow ([299d59e][355])
- **github:** `docker` workflow ([4e9b676][356])

#### Chore

- **pre-commit:** `just-fmt` pre-commit hook ([57b16f2][357])
- **pre-commit:** `md-fmt` pre-commit hook ([8c4b6c4][358])
- **docs:** fix `markdown` file exception `.gitignore` ([b501fa4][359])
- **build:** local `.gitignore` ([755f5d2][360])
- **internal:** local `.gitignore` ([825e7c2][361])
- **sdk:** local `.gitignore` ([f55402b][362])
- **cmd:** local `.gitignore` ([6ff23fe][363])
- **api:** local `.gitignore` ([a160290][364])
- **docs:** local `.gitignore` ([fbfd5b7][365])
- **assets:** local `.gitignore` ([502e7a5][366])
- **fixtures:** local `.gitignore` ([7a098f4][367])
- simplify `.editorconfig` file ([b61d49c][368])
- fixed `.editorconfig` file ([a8db8f7][369])
- **pre-commit:** `go-mod-tidy` pre-commit hook ([713d5ab][370])
- **pre-commit:** `go-fmt` pre-commit hook ([2fbb351][371])
- **github:** `CODEOWNERS` file ([7d5618d][372])
- **vscode:** `tasks` configuration file ([8d9e1cd][373])
- **vscode:** `settings` configuration file ([3ec3faf][374])
- **vscode:** `launch` configuration file ([7ab2d30][375])
- **vscode:** `extensions` configuration file ([2f05faf][376])
- `gitpod` config ([6aeea05][377])
- go vendor dependency management with `tools.go` ([82fea78][378])
- `.env` file init ([24c7238][379])
- `pre-commit` config file ([3d8d786][380])
- **linter:** `cspell` golang dictionary ([7b20441][381])
- **linter:** `cspell` generic dictionary ([b95cfbe][382])
- **linter:** `cspell` config file ([63d43ce][383])
- **linter:** `golangci` config file ([87a9658][384])
- **linter:** `revive` config file ([40abb30][385])
- **linter:** `.markdownlintignore` file ([eb1bae8][386])
- `.versionrc` file ([bee9668][387])
- `.stignore` file ([5bb284d][388])
- `.editorconfig` file ([640d343][389])
- `.dockerignore` file ([aabfa50][390])
- `gitignore` file ([8c88606][391])
- **linter:** `commitlint` config ([4f34502][392])

[1]: https://github.com/da-moon/northern-labs-interview/compare/v0.4.0...v0.5.0
[2]:
...
[9]: https://github.com/da-moon/northern-labs-interview/compare/v0.3.0...v0.4.0
[10]:
