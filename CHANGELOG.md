...
- **changelog:** v0.8.0 ([9522755][2])

#### CI

- **dockeer:** trigger build on changes to any `*.go` file ([7ec1748][3])

## [v0.8.0][4] (2023-02-15)

### Documentation

- add some instructions and context ([344ff9a][5])
- update `just` target in main `README` file ([68e9779][6])
- add `Roadmap` ([a3b0242][7])
- `swagger` yaml ([efb738c][8])
- **changelog:** v0.7.0 ([13a5032][9])

## [v0.7.0][10] (2023-02-15)

### Features

- **cmd/podinfo/commands/server:** parse redis info with flags ([8e57115][11])
- **api/handlers/cache:** register **DELETE** `/cache/{key}` route in API group
  `Register()` ([a5ab3a8][12])
- **api/handlers/cache:** register **DELETE** `/cache/{key}` route in API group
  `Register()` ([d12f7db][13])
- **api/handlers/cache/delete:** `handler` implementation ([07c94d5][14])

### Documentation

- added code stats ([3e0e1ef][15])
- **api/handlers/cache/delete:** package synopsis ([d0e25cb][16])
- **changelog:** v0.7.0 ([8b5e5d2][17])

### [v0.6.3][18] (2023-02-15)

#### Features

- **api/handlers/cache:** register **GET** `/cache/{key}` route in API group
  `Register()` ([ab70334][19])
- **api/handlers/cache/get:** route `register` implementation ([9935643][20])
- **api/handlers/cache/get:** `handler` implementation ([f154df8][21])

#### Documentation

- **api/handlers/cache/doc:** package synopsis ([9de9d35][22])
- **changelog:** v0.7.0 ([61739b5][23])

### [v0.6.2][24] (2023-02-15)

#### Features

- **api/handlers/cache:** register **PUT** `/cache/{key}` route in API group
  `Register()` ([b7cb2ba][25])
- **api/handlers/cache/put:** route `register` implementation ([6696e26][26])
- **api/handlers/cache/put:** `handler` implementation ([15a177c][27])

#### Documentation

- **api/handlers/cache/put:** package synopsis ([26257c2][28])
- **changelog:** v0.7.0 ([1b6e7f1][29])

### [v0.6.1][30] (2023-02-15)

#### Features

- **api/handlers/cache:** register **POST** `/cache/{key}` route in API group
  `Register()` ([f2f2164][31])
- **api/handlers/cache/post:** route `register` implementation ([fb15f04][32])
- **api/handlers/cache/post:** `handler` implementation ([86f9e9d][33])

#### Documentation

- **api/handlers/cache:** package synopsis ([1e8dc7e][34])
- **api/handlers/cache/post:** package synopsis ([f878c09][35])
- **changelog:** v0.6.0 ([cf372a5][36])

## [v0.6.0][37] (2023-02-15)

### Features

- **api/handlers/cache/shared:** `preflight` request handler ([489db81][38])
- **api/handlers/cache/shared:** `API group` shared constructs ([47b687d][39])
- **cmd/podinfo/commands/server:** flags to read `redis` config ([76a07eb][40])
- **api/core:** add `redis` configuration fields and methods ([cc54fcf][41])
- **internal/cli/value:** handle `int` type cli flags ([d26c406][42])

### Documentation

- **api/handlers/cache/shared:** package synopsis ([2732306][43])
- **changelog:** v0.5.0 ([c313777][44])
...
- **docker/podinfo:** minor changes to build script ([9e7f04a][47])

### Chore

- **re-commit:** hook updates ([bff048a][48])

## [v0.5.0][49] (2023-02-15)

### [v0.4.1][50] (2023-02-15)

#### Features

- **api/handlers:** register **GET** `/delay/{seconds}` route in `Initialize()`
  ([5a9dc8e][51])
- **api/handlers/delay:** route `register` implementation ([f39830b][52])
- **api/handlers/delay:** `handler` implementation ([bf469a3][53])
- **api/handlers/delay:** `response` setup ([d22dc78][54])

#### Documentation

- **changelog:** v0.5.0 ([c313777][44])
- **api/handlers/delay:** package synopsis ([e260245][55])
- **changelog:** v0.4.0 ([d7d5af7][56])

#### Build System

- **build/just/podinfo:** `delay-probe` recipe ([9d0b55f][57])

## [v0.4.0][58] (2023-02-15)

### Features

- **api/handlers:** register `/headers` route in `Initialize()` ([10cef5d][59])
- **api/handlers/headers:** route `register` implementation ([989f948][60])
- **api/handlers/headers:** `handler` implementation ([9871e64][61])
- **api/handlers/headers:** `response` type ([019355e][62])

### Documentation

- **api/handlers/headers:** package synopsis ([489218a][63])

### Build System

- **build/just/podinfo:** `headers-probe` recipe ([239a061][64])

## [v0.3.0][65] (2023-02-15)

### Features

- **api/handlers:** register `/env` route in `Initialize()` ([2d98b6a][66])
- **api/handlers/env:** routte `register` implementation ([958bc47][67])
- **api/handlers/env:** `handler` implementation ([0ef5a8f][68])
- **api/handlers/env:** `response` type ([877b7e4][69])

### Documentation

- **api/handlers/env:** package synopsis ([edc489e][70])

### Build System

- **build/just/podinfo:** `env-probe` recipe ([b66f28b][71])

### [v0.2.2][72] (2023-02-15)

#### Features

- **api/handlers:** register `/readyz/enable` route in `Initialize()`
  ([dead392][73])
- **api/handlers/readiness/enable:** route init ([b56a400][74])
- **api/handlers/readiness/enable:** handler setup ([9356de0][75])

#### Documentation

- **api/handlers/readiness/enable:** package synopsis ([faeaf50][76])

#### Build System

- **build/just/podinfo:** `readiness-probe-enable` recipe ([65c6272][77])

### [v0.2.1][78] (2023-02-15)

#### Features

- **api/handlers:** register the route in `Initialize()` ([ae99b84][79])
...
- **api/handlers/readiness/disable:** `HandlerFn` synopsis ([ac1c0ee][87])
- **api/handlers/readiness/disable:** `handler` struct synopsis ([5e8ae1e][88])
- **api/handlers/readiness/disable:** package synopsis ([4753ee2][89])
- **changelog:** v0.2.0 ([2ec37fc][90])

#### Build System

- **build/just/podinfo:** `readiness-probe-disable` recipe ([f0efeb5][91])

## [v0.2.0][92] (2023-02-15)

### Features

- **api/handlers/readiness:** `handler.Register()` implementation
  ([229f6ef][93])
- **api/handlers/readiness:** `init()` implementation ([316c88d][94])
- **api/handlers/readiness:** `HandlerFn` implementation ([fa4e4e0][95])
- **api/handlers/readiness:** `handler.GetStatus()` implementation
  ([6975ceb][96])
- **api/handlers/readiness:** `handler.SetStatus()` implementation
  ([0ae4c75][97])
- **api/handlers/readiness:** `handler.GetLogger()` synopsis ([1fb4903][98])
- **api/handlers/readiness:** `handler.GetLogger()` implementation
  ([2af2f25][99])
- **api/handlers/readiness:** `handler.SetLogger()` implementation
  ([a34f22d][100])
- **api/handlers/readiness:** `handler` struct implementation ([4a73558][101])
- **api/handlers/readiness:** `Response` struct implementation ([8ea8855][102])
- **api/handlers/readiness:** `Status.String()` implementation ([f81e205][103])
- **api/handlers/readiness:** `Status` enum ([c45a277][104])
- **sdk/api/response:** `LogEntry()` implementation ([c62180d][105])

### Documentation

- **build/just/podinfo:** `readiness-probe` recipe ([a989ce1][106])
- **api/handlers/readiness:** `HandlerFn` synopsis ([5b226c3][107])
- **api/handlers/readiness:** `handler.GetStatus()` synopsis ([7f85163][108])
- **api/handlers/readiness:** `handler.SetStatus()` synopsis ([db54578][109])
- **api/handlers/readiness:** `handler.SetLogger()` synopsis ([2ac7d67][110])
- **api/handlers/readiness:** `handler` struct synopsis ([14fcb57][111])
- **api/handlers/readiness:** `Response` struct synopsis ([7c7ecff][112])
- **api/handlers/readiness:** `Status.String()` synopsis ([777320c][113])
- **api/handlers/readiness:** `Status` enum ([9788dfb][114])
- **api/handlers/readiness:** package synopsis ([92c17f3][115])
- **sdk/api/response:** `LogEntry()` synopsis ([c9c5f7d][116])
- **changelog:** v0.2.0 ([c46195b][117])

### Refactors

- **api/handlers/liveness:** new pattern of writing `HandlerFn`
  ([d270881][118])
- **sdk/api/response:** `Write` function ([66fd066][119])
- **api/handlers/liveness:** change route impl pattern ([6efbf25][120])

### Build System

- **build/just/podinfo:** `readiness-probe` recipe ([14a6fe0][121])

### Chore

- **gitpod:** fix `gitpod` shell config in dockerfile ([ad05fc9][122])

### [v0.1.1][123] (2023-02-13)

#### Documentation

- **changelog:** `v0.1.0` ([e1bdb33][124])

#### Build System

- **just/git:** prune refs in `git-fetch` recipe ([69d5e05][125])

## [v0.1.0][126] (2023-02-13)

### Features

- **sdk/api/response:** `WriteJSON()` function implementation ([ac8c96c][127])
- **sdk/api/response:** `WriteSuccessfulJSONRaw()` function implementation
  ([f264be1][128])
- **api/handlers:** remove `Prefix` from pre-flight handler ([ae48e9d][129])
- **api/handlers:** Register and initialize `kubernetes-liveness-probe` route
  ([1c416f5][130])
- **api/handlers/liveness:** `Initialize()` function ([73548a0][131])
- **api/handlers/liveness:** `New()` function ([016f07c][132])
- **api/handlers/liveness:** `Handler` struct ([133a5a8][133])
- **api/handlers/liveness:** package constants ([a0b8f71][134])
- **api/handlers/liveness:** `Response` struct ([9bc1341][135])

### Bug Fixes

- **sdk/api/response:** address linter complaints ([a9eed4e][136])

### Documentation

- **docker/buildx:** `gitpod` target ([11b8055][137])
- `liveness-probe` instruction ([fc5852c][138])
- **sdk/api/response:** `WriteJSON()` function synopsis ([7e25e0a][139])
- **sdk/api/response:** `WriteSuccessfulJSONRaw()` synopsis ([63d16c4][140])
- **swaggger:** add `GET` verb for `/healthz` ([5a0bb54][141])
- fix instruction to run mage's `build` target ([d35f513][142])
- **api/handlers/liveness:** `Initialize()` function ([a8993b7][143])
- **api/handlers/liveness:** `New()` function ([add5240][144])
- **api/handlers/liveness:** `Handler` struct ([06f7e41][145])
- **api/handlers/liveness:** package constants ([0e5f809][146])
- **api/handlers/liveness:** `Status` enum ([2ac0c5e][147])
- **api/handlers/liveness:** package synopsis ([efe22ac][148])
- **changelog:** updated changelog for v0.0.1 ([533f465][149])

### Refactors

- **api/handlers/liveness:** update `handler()` to write response json without
  adding additional fields ([985c2cf][150])
...
- **go-releaser:** do not sign archive ([b931100][153])
- **docker:** `gitpod` target ([006af3c][154])
- **just/bootstrap:** add `rust` toolchain ([6d9e725][155])
- **docker:** laxer package versioning in dockerfile ([9db2bb8][156])
- **docker:** fixed minor issues with `docker-bake.hcl` file ([747b4f4][157])
- **just/bootstrap:** add `bootstrap-os-pkgs` dependency to `bootstrap` target
  ([c397414][158])
- **just/go:** fix `mage` install in `_build-go` target ([7a6a5d9][159])
- **just/commit:** fix `bootstrap-pre-commit` hook installation
  ([495f420][160])
- **just/semver:** changed changelog commit message pattern ([9a5964e][161])

### CI

- **docker:** detect `TAG` ([5ca9bde][162])
- **go:** add `go-releaser` step ([74090a2][163])
- **release:** fix deprecated flags in `go-releaser` step ([0c641be][164])
- update min go version to `1.20` ([385d829][165])
- **go:** fixed arguments in `test` step ([2e45224][166])
- **go:** fixed arguments in `build` step ([55e6ae7][167])
- **release:** remove `unshallow` step ([2011e4f][168])
- **release:** update `setup-go` and `goreleaser-action` actions
  ([ea4cc92][169])

### Chore

- **gitpod:** source `gitpod` variables ([168e63f][170])
- **gitpod:** `rust` toolchain configuration ([e3e3d0d][171])
- **gitpod:** add `bootstrap` task ([d2ce4f1][172])
- **gitpod:** added more tools to the dockerfile ([79f5f6d][173])
- minor fix ([f9bc049][174])
- minor fix ([9ae11b2][175])
- **pre-commit:** ensure Justfile is identical to upstream in `just-fmt.sh`
  script ([ee99516][176])
- **gitpod:** replace `yarn` with `npm` in Dockerfile ([927e64b][177])
- change image in `.gitpod.yml` ([f494de7][178])
- fix `.gitpod.yml` ([8c3577e][179])

### v0.0.1 (2023-02-12)

#### Features

- **api:** init ([3974f95][180])
- **api/core:** init ([891fa92][181])
- **api/errors:** init ([dc9c0cc][182])
- **api/handlers:** init ([a9354fe][183])
- **api/middlewares:** init ([03877c6][184])
- **api/registry:** init ([c093b2a][185])
- **cmd/podinfo:** init ([a3c1ebf][186])
- **internal/cryptoutil:** init ([34a4597][187])
- **internal/files:** init ([4ac385c][188])
- **internal/golang-lru:** init ([f1264aa][189])
- **internal/locksutil:** init ([09e59d1][190])
- **internal/logger:** init ([e066d10][191])
- **internal/multierror:** init ([a39b7c2][192])
- **internal/pathmanager:** init ([489996c][193])
- **internal/permitpool:** init ([a29c5d7][194])
- **internal/prettyprint:** init ([2bc4ce1][195])
- **internal/primitives:** init ([1a67ad6][196])
- **internal/runtimex:** init ([76eb234][197])
- **internal/testutils:** init ([c188be8][198])
- **internal/urandom:** init ([58ed4ff][199])
- **internal/version:** init ([4a98993][200])
- **sdk/physical:** init ([f8d487e][201])
- **internal/backoff/constant:** init ([f70b48d][202])
- **internal/backoff/exponential:** init ([437e93c][203])
- **internal/cli/data:** init ([9d115ad][204])
- **internal/cli/decoder:** init ([5b380a7][205])
- **internal/cli/flagset:** init ([a233141][206])
- **internal/cli/value:** init ([aef98ca][207])
- **internal/golang-lru/simplelru:** init ([8196569][208])
- **internal/logger/slack:** init ([1e97608][209])
- **internal/radix-tree/immutable:** init ([5dbb2e9][210])
- **internal/radix-tree/mutable:** init ([fade8c6][211])
- **sdk/api/address:** init ([69918d7][212])
- **sdk/api/fastjson:** init ([e5403e6][213])
- **sdk/api/metrics:** init ([fd5e5e2][214])
- **sdk/api/port:** init ([979298e][215])
- **sdk/api/proto:** init ([3ddbd38][216])
- **sdk/api/response:** init ([76ab9c8][217])
- **sdk/api/route:** init ([2a7f6c7][218])
- **sdk/physical/access:** init ([829e8ef][219])
- **sdk/physical/cache:** init ([48e7940][220])
- **sdk/physical/chroot:** init ([5eb4b18][221])
- **sdk/physical/encoding:** init ([b1895bf][222])
- **sdk/physical/error-injector:** init ([fa52696][223])
- **sdk/physical/latency:** init ([7d4928f][224])
- **sdk/physical/retry:** init ([8660a4d][225])
- **cmd/podinfo/commands/server:** init ([540b954][226])
- **cmd/podinfo/commands/version:** init ([df8d8d1][227])
- **docker/release:** minimal `Dockerfile` for the binary ([c4cd6da][228])

#### Documentation

- init ([93e80f2][229])
- **build/go:** `Build` target synopsis ([a9e2bfb][230])
- **just/podinfo:** `run` target synopsis ([966607f][231])
- **just/podinfo:** `kill` target synopsis ([d4bb819][232])
- **just/go:** `build-go` target synopsis ([89c2bae][233])
- **just/go:** `clean-go` target synopsis ([7089f0b][234])
- **just/go:** `lint-go` target synopsis ([25b8479][235])
- **just/go:** `format-go` target synopsis ([1c62db8][236])
- **just/go:** `bootstrap-go` target synopsis ([e37bcd0][237])
- **just/go:** `_build` target synopsis ([50231ce][238])
- **just/go:** `_go` target synopsis ([f240c28][239])
- **just/go:** `_lint-go` target synopsis ([5ac43ba][240])
- **just/semver:** `bootstrap-semver` target synopsis ([92ec6b4][241])
- **just/markdown:** `_format-markdown` target synopsis ([2721074][242])
- **just/justfile:** `format-just` target synopsis ([78a7965][243])
- **just/json:** `format-json` target synopsis ([8c5778c][244])
- **just/json:** `_format-json` target synopsis ([6a417bd][245])
- **just/bash:** `lint-bash` target synopsis ([2e74c8d][246])
- **just/bash:** `format-bash` target synopsis ([b59a5d7][247])
- **just/bash:** `_lint-bash` target synopsis ([08b1ac6][248])
- **just/bash:** `_format-bash` target synopsis ([ef340bb][249])
- **just/misc:** `snapshot` target synopsis ([4026b9e][250])
- **just/misc:** `vscode-tasks` target synopsis ([deb5e1d][251])
- **just/semver:** `generate-changelog` target synopsis ([aa5683b][252])
- **just/semver:** `patch-release` target synopsis ([74afa35][253])
- **just/semver:** `minor-release` target synopsis ([2bde4d8][254])
- **just/semver:** `major-release` target synopsis ([03bb13d][255])
- **just/semver:** variable synopsis ([a5db8af][256])
- **just/commit:** `commit` target synopsis ([d02b807][257])
- **just/commit:** `bootstrap-pre-commit` target synopsis ([c367eae][258])
- **just/commit:** `_pre-commit` target synopsis ([6aee1b8][259])
- **just/git:** `git-add` target synopsis ([f84a9eb][260])
- **just/git:** `_git-delta` target synopsis ([3781d54][261])
- **just/git:** `_git-delta` target synopsis ([b8d961d][262])
- **just/bootstrap:** `_update-rust` target synopsis ([0d1588e][263])
- **just/bootstrap:** `_validate-rust` target synopsis ([b223255][264])
- **just/bootstrap:** `_install-nodejs-package` target synopsis
  ([58aabd6][265])
- **just/bootstrap:** `_bootstrap-nodejs` target synopsis ([00df92c][266])
- **just/bootstrap:** `_core-pkgs` target synopsis ([9a78d0a][267])
- **just/bootstrap:** `_install-os-package` target synopsis ([b817954][268])
- **just/bootstrap:** `_update-os-pkgs` target synopsis ([4b94227][269])
- **just/bootstrap:** `kary-comments` target synopsis ([f80992f][270])
- **just:** common variables ([9cc3843][271])
- **build/go/targets/test:** `Target` function synopsis ([7a17aad][272])
- **build/go/targets:** package synopsis ([40e593d][273])
- **build/go/targets/test:** package synopsis ([7e5375b][274])
- **build/go/targets/build:** package synopsis ([960062d][275])
- **build/go/git:** package synopsis ([2a1ffd4][276])
- **build/go/version:** package synopsis ([265da8c][277])
- **api:** synopsis ([295aad0][278])
- **sdk:** synopsis ([9f0d098][279])
- **api/core:** synopsis ([9ef7b34][280])
- **api/handlers:** synopsis ([b0e0874][281])
- **api/middlewares:** synopsis ([d3233c8][282])
- **api/registry:** synopsis ([e801ead][283])
- **internal/files:** synopsis ([a163f57][284])
- **internal/golang-lru:** synopsis ([d63c0a7][285])
- **internal/logger:** synopsis ([5d65330][286])
- **internal/permitpool:** synopsis ([41feade][287])
- **internal/prettyprint:** synopsis ([87c51ba][288])
- **internal/primitives:** synopsis ([8a083ac][289])
- **internal/runtimex:** synopsis ([dffbbdc][290])
- **internal/testutils:** synopsis ([3895ee7][291])
- **internal/urandom:** synopsis ([ab5c0b9][292])
- **sdk/api:** synopsis ([f657f44][293])
- **sdk/physical:** synopsis ([9706c76][294])
- **cmd/podinfo/commands:** synopsis ([108d9eb][295])
- **internal/cli/data:** synopsis ([3574a9c][296])
- **internal/cli/decoder:** synopsis ([a13ad40][297])
- **internal/cli/flagset:** synopsis ([0a9d0c1][298])
- **internal/logger/slack:** synopsis ([83a078c][299])
- **internal/radix-tree/immutable:** synopsis ([78abe82][300])
- **internal/radix-tree/mutable:** synopsis ([4e53b91][301])
- **sdk/api/address:** synopsis ([23ab44b][302])
- **sdk/api/fastjson:** synopsis ([2a7c790][303])
- **sdk/api/metrics:** synopsis ([c505728][304])
- **sdk/api/port:** synopsis ([1090e11][305])
- **sdk/api/proto:** synopsis ([197fad7][306])
- **sdk/api/response:** synopsis ([5cdbfab][307])
- **sdk/api/route:** synopsis ([6d23ed6][308])
- **sdk/physical/access:** synopsis ([cea7bee][309])
- **sdk/physical/cache:** synopsis ([13e7f7d][310])
- **sdk/physical/chroot:** synopsis ([4b31bb4][311])
- **sdk/physical/encoding:** synopsis ([49a1e33][312])
- **sdk/physical/error-injector:** synopsis ([70446b1][313])
- **sdk/physical/latency:** synopsis ([1f906c5][314])
- **sdk/physical/retry:** synopsis ([13983aa][315])
- **cmd/podinfo/commands/server:** synopsis ([942978f][316])
- **cmd/podinfo/commands/version:** synopsis ([26ea212][317])
- **docker-bake:** usage guide ([5344b78][318])
- **docker-bake:** `release` target synopsis ([e55beca][319])
- **docker-bake:** `default` group synopsis ([baf2270][320])
- **docker-bake:** `TAG` variable synopsis ([abe018f][321])
- **docker-bake:** `AMD64` variable synopsis ([7909900][322])
- **docker-bake:** `ARM64` variable synopsis ([750e36d][323])
- **docker-bake:** `REGISTRY_USERNAME` variable synopsis ([4c68a04][324])
- **docker-bake:** `REGISTRY_HOSTNAME` variable synopsis ([83e5534][325])
- **docker-bake:** `LOCAL` variable synopsis ([e238d0e][326])
- **github:** `programming_task` issue template ([dba5a78][327])
- **github:** `feature_request` issue template ([4124f12][328])
- **github:** `bug_report` issue template ([c7d8513][329])
- **github:** `api_endpoint_spec` issue template ([d60a2a9][330])

#### Refactors

- **mage:** remove old files ([eabe9ea][331])

#### Tests

- **api/core:** init ([0598dda][332])
- **internal/files:** init ([ffb9e6b][333])
- **internal/logger:** init ([1d6b435][334])
- **internal/primitives:** init ([b3ebabc][335])
- **internal/backoff/constant:** init ([c3255c2][336])
- **internal/backoff/exponential:** init ([588c83a][337])
- **internal/cli/decoder:** init ([1b3cfbe][338])
- **internal/cli/value:** init ([4aeaebb][339])
- **sdk/api/fastjson:** init ([01cd7be][340])

#### Build System

- **just/core:** aggregator targets ([3382f77][341])
- **just/podinfo:** `run` target implementation ([e262bfa][342])
- **just/podinfo:** `kill` target implementation ([40a0637][343])
- **just/go:** `build-go` target implementation ([d8670aa][344])
- **just/go:** `clean-go` target implementation ([8dc7e7c][345])
- **just/go:** `lint-go` target implementation ([14209fd][346])
- **just/go:** `format-go` target implementation ([0126826][347])
- **just/go:** `bootstrap-go` target implementation ([39b68ce][348])
- **just/go:** `_build` hidden target implementation ([47dc4e8][349])
- **just/go:** `_go` hidden target implementation ([26a247a][350])
- **just/go:** `_lint-go` hidden target implementation ([351a32a][351])
- **just/semver:** `bootstrap-semver` target implementation ([3ca58f4][352])
- **just/markdown:** `_format-markdown` hidden target implementation
  ([852e53e][353])
- **just/justfile:** `format-just` target implementation ([eb8efa2][354])
- **just/json:** `format-json` target implementation ([e540c34][355])
- **just/json:** `_format-json` hidden target implementation ([2754846][356])
- **just/bash:** `lint-bash` target implementation ([5cfd1f9][357])
- **just/bash:** `format-bash` target implementation ([05d97b0][358])
- **just/bash:** `_lint-bash` hidden target implementation ([2e56839][359])
- **just/bash:** `_format-bash` hidden target implementation ([2214242][360])
- **just/misc:** `snapshot` target implementation ([184f86e][361])
- **just/misc:** `vscode-tasks` target implementation ([8669e48][362])
- **just/semver:** `generate-changelog` target implementation ([d9813b6][363])
- **just/semver:** `patch-release` target implementation ([0ee99d8][364])
- **just/semver:** `minor-release` target implementation ([47c8d9d][365])
- **just/semver:** `major-release` target implementation ([4ca9c5c][366])
- **just/semver:** variable declaration ([fb9c78a][367])
- **just/commit:** `commit` target implementation ([f574bf3][368])
- **just/commit:** `bootstrap-pre-commit` target implementation
  ([1243472][369])
- **just/git:** `_pre-commit` hidden target implementation ([e5c5206][370])
- **just/git:** `git-add` target implementation ([b053a64][371])
- **just/git:** `git-fetch` target implementation ([28764fb][372])
- **just/git:** `_git-delta` hidden target implementation ([33b956f][373])
...
- **just/bootstrap:** `_update-os-pkgs` hidden target implementation
  ([7fb7d14][381])
- **just/bootstrap:** `kary-comments` target implementation ([8ffe083][382])
- **just:** common config ([86033e0][383])
- **go:** moved from `magefile.go` ([52e7886][384])
- **go/targets/test:** moved from `mage/test` ([84ef4a7][385])
- **go/targets/build:** moved from `mage/build` ([a07a063][386])
- **go/git:** moved from `mage/git` ([ae05d7a][387])
- **go/version:** moved from `internal/version` ([1906bdc][388])
- **docker-bake:** `release` target implementation ([778b6f7][389])
- **docker-bake:** `TAG` variable declaration ([dd58811][390])
- **docker-bake:** `AMD64` variable declaration ([763dcb7][391])
- **docker-bake:** `ARM64` variable declaration ([7feeae8][392])
- **docker-bake:** `REGISTRY_USERNAME` variable declaration ([c0493f8][393])
- **docker-bake:** `REGISTRY_HOSTNAME` variable declaration ([0cebd31][394])
- **docker-bake:** `LOCAL` variable declaration ([a89e0be][395])
- **docker/release:** added buildx installer/setup to the script
  ([607964a][396])
- **docker/release:** multi-arch builder script ([2d320e6][397])
- `go-releaser` config ([25bea21][398])
- **mage:** `magefile` init ([2e7af35][399])
- **test:** `test` mage targets ([84e27ca][400])
- **build:** `build` mage targets ([5471c34][401])
- **git:** `git` auxiliary library ([4908743][402])

#### CI

- **github:** `release` workflow ([fc1e8f4][403])
- **github:** `go` workflow ([299d59e][404])
- **github:** `docker` workflow ([4e9b676][405])

#### Chore

- **pre-commit:** `just-fmt` pre-commit hook ([57b16f2][406])
- **pre-commit:** `md-fmt` pre-commit hook ([8c4b6c4][407])
- **docs:** fix `markdown` file exception `.gitignore` ([b501fa4][408])
- **build:** local `.gitignore` ([755f5d2][409])
- **internal:** local `.gitignore` ([825e7c2][410])
- **sdk:** local `.gitignore` ([f55402b][411])
- **cmd:** local `.gitignore` ([6ff23fe][412])
- **api:** local `.gitignore` ([a160290][413])
- **docs:** local `.gitignore` ([fbfd5b7][414])
- **assets:** local `.gitignore` ([502e7a5][415])
- **fixtures:** local `.gitignore` ([7a098f4][416])
- simplify `.editorconfig` file ([b61d49c][417])
- fixed `.editorconfig` file ([a8db8f7][418])
- **pre-commit:** `go-mod-tidy` pre-commit hook ([713d5ab][419])
- **pre-commit:** `go-fmt` pre-commit hook ([2fbb351][420])
- **github:** `CODEOWNERS` file ([7d5618d][421])
- **vscode:** `tasks` configuration file ([8d9e1cd][422])
- **vscode:** `settings` configuration file ([3ec3faf][423])
- **vscode:** `launch` configuration file ([7ab2d30][424])
- **vscode:** `extensions` configuration file ([2f05faf][425])
- `gitpod` config ([6aeea05][426])
- go vendor dependency management with `tools.go` ([82fea78][427])
- `.env` file init ([24c7238][428])
- `pre-commit` config file ([3d8d786][429])
- **linter:** `cspell` golang dictionary ([7b20441][430])
- **linter:** `cspell` generic dictionary ([b95cfbe][431])
- **linter:** `cspell` config file ([63d43ce][432])
- **linter:** `golangci` config file ([87a9658][433])
- **linter:** `revive` config file ([40abb30][434])
- **linter:** `.markdownlintignore` file ([eb1bae8][435])
- `.versionrc` file ([bee9668][436])
- `.stignore` file ([5bb284d][437])
- `.editorconfig` file ([640d343][438])
- `.dockerignore` file ([aabfa50][439])
- `gitignore` file ([8c88606][440])
- **linter:** `commitlint` config ([4f34502][441])

[1]: https://github.com/da-moon/northern-labs-interview/compare/v0.8.0...v0.8.1
[2]:
  https://github.com/da-moon/northern-labs-interview/commit/952275560362291b3aca46793562f9b76196bf90
[3]:
  https://github.com/da-moon/northern-labs-interview/commit/7ec17481025b66ff69c94d4904f11ff2ddb3d544
[4]: https://github.com/da-moon/northern-labs-interview/compare/v0.7.0...v0.8.0
[5]:
  https://github.com/da-moon/northern-labs-interview/commit/344ff9ae23eee48c992fdc4e663ea0fedd324708
[6]:
  https://github.com/da-moon/northern-labs-interview/commit/68e97799e8952aa04bd0d692943c494377c314c6
[7]:
  https://github.com/da-moon/northern-labs-interview/commit/a3b0242d50158bd386735581ab8e1dd22cc65b20
[8]:
  https://github.com/da-moon/northern-labs-interview/commit/efb738cc1c46fd084a577426d275ff65337a145c
[9]:
  https://github.com/da-moon/northern-labs-interview/commit/13a50326a6671a4246854d5d948182aed907fff2
[10]:
  https://github.com/da-moon/northern-labs-interview/compare/v0.6.3...v0.7.0
[11]:
  https://github.com/da-moon/northern-labs-interview/commit/8e57115cc8778e3ece6885587881b4c6115d3307
[12]:
  https://github.com/da-moon/northern-labs-interview/commit/a5ab3a891ccfde2c4738da6ddcc79bee4805c182
[13]:
  https://github.com/da-moon/northern-labs-interview/commit/d12f7db17fdd6722aa6eec487928ac441c31ba11
[14]:
  https://github.com/da-moon/northern-labs-interview/commit/07c94d51c9543630f9436f238585b70429dcdc60
[15]:
  https://github.com/da-moon/northern-labs-interview/commit/3e0e1efd2247065243b8f5c9fde5c0416d52f311
[16]:
  https://github.com/da-moon/northern-labs-interview/commit/d0e25cbfb7b7ec66ce6b8015755bed6ad000b1b4
[17]:
  https://github.com/da-moon/northern-labs-interview/commit/8b5e5d2034c96183020879cbe910e86a68909c21
[18]:
  https://github.com/da-moon/northern-labs-interview/compare/v0.6.2...v0.6.3
[19]:
  https://github.com/da-moon/northern-labs-interview/commit/ab703346321ed38738d733022f5ad32a3ae256f6
[20]:
  https://github.com/da-moon/northern-labs-interview/commit/9935643552c94e1ddf9614315caaac0f27321045
[21]:
  https://github.com/da-moon/northern-labs-interview/commit/f154df8c72d4e3fa5da7ad46e5bb8155b4cc793a
[22]:
  https://github.com/da-moon/northern-labs-interview/commit/9de9d35a1bf70526e079cc701a46a8aebf51ec52
[23]:
  https://github.com/da-moon/northern-labs-interview/commit/61739b5b77ebcb89ee5e8a7fcbc7232de0bddee0
[24]:
  https://github.com/da-moon/northern-labs-interview/compare/v0.6.1...v0.6.2
[25]:
  https://github.com/da-moon/northern-labs-interview/commit/b7cb2bac6158e70794aeac4f3c70821b13fa1441
[26]:
  https://github.com/da-moon/northern-labs-interview/commit/6696e262bf7cf0790f3053c7d04b9dd74a9fe91b
[27]:
  https://github.com/da-moon/northern-labs-interview/commit/15a177c112e32b2dce6bf91556d145f2ae93109b
[28]:
  https://github.com/da-moon/northern-labs-interview/commit/26257c2f09b4272339f28a7d507b5354d3636df9
[29]:
  https://github.com/da-moon/northern-labs-interview/commit/1b6e7f10ffa32cbb5db368f1d8830ee638c6d634
[30]:
  https://github.com/da-moon/northern-labs-interview/compare/v0.6.0...v0.6.1
[31]:
  https://github.com/da-moon/northern-labs-interview/commit/f2f2164ae1858a9f7c356e1db8492b10ad2fc780
[32]:
  https://github.com/da-moon/northern-labs-interview/commit/fb15f041bc06c7ef1d7125af2df4df456ad6449a
[33]:
  https://github.com/da-moon/northern-labs-interview/commit/86f9e9d84c5a0aaf787ea52425631997ac98f1f0
[34]:
  https://github.com/da-moon/northern-labs-interview/commit/1e8dc7edd45ada829f64c8a771a216fe6b0f75cb
[35]:
  https://github.com/da-moon/northern-labs-interview/commit/f878c09e3d386081c7d695280b93cb8418445535
[36]:
  https://github.com/da-moon/northern-labs-interview/commit/cf372a5d5776b62452c58a9b3061e3f49f9a83e5
[37]:
