...
- **api/handlers/cache:** register **GET** `/cache/{key}` route in API group
  `Register()` ([ab70334][2])
- **api/handlers/cache/get:** route `register` implementation ([9935643][3])
- **api/handlers/cache/get:** `handler` implementation ([f154df8][4])

#### Documentation

- **api/handlers/cache/doc:** package synopsis ([9de9d35][5])
- **changelog:** v0.7.0 ([61739b5][6])
...
- **api/handlers/cache:** register **PUT** `/cache/{key}` route in API group
  `Register()` ([b7cb2ba][8])
- **api/handlers/cache/put:** route `register` implementation ([6696e26][9])
- **api/handlers/cache/put:** `handler` implementation ([15a177c][10])

#### Documentation

- **api/handlers/cache/put:** package synopsis ([26257c2][11])
- **changelog:** v0.7.0 ([1b6e7f1][12])

### [v0.6.1][13] (2023-02-15)

#### Features

- **api/handlers/cache:** register **POST** `/cache/{key}` route in API group
  `Register()` ([f2f2164][14])
- **api/handlers/cache/post:** route `register` implementation ([fb15f04][15])
- **api/handlers/cache/post:** `handler` implementation ([86f9e9d][16])

#### Documentation

- **api/handlers/cache:** package synopsis ([1e8dc7e][17])
- **api/handlers/cache/post:** package synopsis ([f878c09][18])
- **changelog:** v0.6.0 ([cf372a5][19])

## [v0.6.0][20] (2023-02-15)

### Features

- **api/handlers/cache/shared:** `preflight` request handler ([489db81][21])
- **api/handlers/cache/shared:** `API group` shared constructs ([47b687d][22])
- **cmd/podinfo/commands/server:** flags to read `redis` config ([76a07eb][23])
- **api/core:** add `redis` configuration fields and methods ([cc54fcf][24])
- **internal/cli/value:** handle `int` type cli flags ([d26c406][25])

### Documentation

- **api/handlers/cache/shared:** package synopsis ([2732306][26])
- **changelog:** v0.5.0 ([c313777][27])
...
- **docker/podinfo:** minor changes to build script ([9e7f04a][30])

### Chore

- **re-commit:** hook updates ([bff048a][31])

## [v0.5.0][32] (2023-02-15)

### [v0.4.1][33] (2023-02-15)

#### Features

- **api/handlers:** register **GET** `/delay/{seconds}` route in `Initialize()`
  ([5a9dc8e][34])
- **api/handlers/delay:** route `register` implementation ([f39830b][35])
- **api/handlers/delay:** `handler` implementation ([bf469a3][36])
- **api/handlers/delay:** `response` setup ([d22dc78][37])

#### Documentation

- **changelog:** v0.5.0 ([c313777][27])
- **api/handlers/delay:** package synopsis ([e260245][38])
- **changelog:** v0.4.0 ([d7d5af7][39])

#### Build System

- **build/just/podinfo:** `delay-probe` recipe ([9d0b55f][40])

## [v0.4.0][41] (2023-02-15)

### Features

- **api/handlers:** register `/headers` route in `Initialize()` ([10cef5d][42])
- **api/handlers/headers:** route `register` implementation ([989f948][43])
- **api/handlers/headers:** `handler` implementation ([9871e64][44])
- **api/handlers/headers:** `response` type ([019355e][45])

### Documentation

- **api/handlers/headers:** package synopsis ([489218a][46])

### Build System

- **build/just/podinfo:** `headers-probe` recipe ([239a061][47])

## [v0.3.0][48] (2023-02-15)

### Features

- **api/handlers:** register `/env` route in `Initialize()` ([2d98b6a][49])
- **api/handlers/env:** routte `register` implementation ([958bc47][50])
- **api/handlers/env:** `handler` implementation ([0ef5a8f][51])
- **api/handlers/env:** `response` type ([877b7e4][52])

### Documentation

- **api/handlers/env:** package synopsis ([edc489e][53])

### Build System

- **build/just/podinfo:** `env-probe` recipe ([b66f28b][54])

### [v0.2.2][55] (2023-02-15)

#### Features

- **api/handlers:** register `/readyz/enable` route in `Initialize()`
  ([dead392][56])
- **api/handlers/readiness/enable:** route init ([b56a400][57])
- **api/handlers/readiness/enable:** handler setup ([9356de0][58])

#### Documentation

- **api/handlers/readiness/enable:** package synopsis ([faeaf50][59])

#### Build System

- **build/just/podinfo:** `readiness-probe-enable` recipe ([65c6272][60])

### [v0.2.1][61] (2023-02-15)

#### Features

- **api/handlers:** register the route in `Initialize()` ([ae99b84][62])
...
- **api/handlers/readiness/disable:** `HandlerFn` synopsis ([ac1c0ee][70])
- **api/handlers/readiness/disable:** `handler` struct synopsis ([5e8ae1e][71])
- **api/handlers/readiness/disable:** package synopsis ([4753ee2][72])
- **changelog:** v0.2.0 ([2ec37fc][73])

#### Build System

- **build/just/podinfo:** `readiness-probe-disable` recipe ([f0efeb5][74])

## [v0.2.0][75] (2023-02-15)

### Features

- **api/handlers/readiness:** `handler.Register()` implementation
  ([229f6ef][76])
- **api/handlers/readiness:** `init()` implementation ([316c88d][77])
- **api/handlers/readiness:** `HandlerFn` implementation ([fa4e4e0][78])
- **api/handlers/readiness:** `handler.GetStatus()` implementation
  ([6975ceb][79])
- **api/handlers/readiness:** `handler.SetStatus()` implementation
  ([0ae4c75][80])
- **api/handlers/readiness:** `handler.GetLogger()` synopsis ([1fb4903][81])
- **api/handlers/readiness:** `handler.GetLogger()` implementation
  ([2af2f25][82])
- **api/handlers/readiness:** `handler.SetLogger()` implementation
  ([a34f22d][83])
- **api/handlers/readiness:** `handler` struct implementation ([4a73558][84])
- **api/handlers/readiness:** `Response` struct implementation ([8ea8855][85])
- **api/handlers/readiness:** `Status.String()` implementation ([f81e205][86])
- **api/handlers/readiness:** `Status` enum ([c45a277][87])
- **sdk/api/response:** `LogEntry()` implementation ([c62180d][88])

### Documentation

- **build/just/podinfo:** `readiness-probe` recipe ([a989ce1][89])
- **api/handlers/readiness:** `HandlerFn` synopsis ([5b226c3][90])
- **api/handlers/readiness:** `handler.GetStatus()` synopsis ([7f85163][91])
- **api/handlers/readiness:** `handler.SetStatus()` synopsis ([db54578][92])
- **api/handlers/readiness:** `handler.SetLogger()` synopsis ([2ac7d67][93])
- **api/handlers/readiness:** `handler` struct synopsis ([14fcb57][94])
- **api/handlers/readiness:** `Response` struct synopsis ([7c7ecff][95])
- **api/handlers/readiness:** `Status.String()` synopsis ([777320c][96])
- **api/handlers/readiness:** `Status` enum ([9788dfb][97])
- **api/handlers/readiness:** package synopsis ([92c17f3][98])
- **sdk/api/response:** `LogEntry()` synopsis ([c9c5f7d][99])
- **changelog:** v0.2.0 ([c46195b][100])

### Refactors

- **api/handlers/liveness:** new pattern of writing `HandlerFn`
  ([d270881][101])
- **sdk/api/response:** `Write` function ([66fd066][102])
- **api/handlers/liveness:** change route impl pattern ([6efbf25][103])

### Build System

- **build/just/podinfo:** `readiness-probe` recipe ([14a6fe0][104])

### Chore

- **gitpod:** fix `gitpod` shell config in dockerfile ([ad05fc9][105])

### [v0.1.1][106] (2023-02-13)

#### Documentation

- **changelog:** `v0.1.0` ([e1bdb33][107])

#### Build System

- **just/git:** prune refs in `git-fetch` recipe ([69d5e05][108])

## [v0.1.0][109] (2023-02-13)

### Features

- **sdk/api/response:** `WriteJSON()` function implementation ([ac8c96c][110])
- **sdk/api/response:** `WriteSuccessfulJSONRaw()` function implementation
  ([f264be1][111])
- **api/handlers:** remove `Prefix` from pre-flight handler ([ae48e9d][112])
- **api/handlers:** Register and initialize `kubernetes-liveness-probe` route
  ([1c416f5][113])
- **api/handlers/liveness:** `Initialize()` function ([73548a0][114])
- **api/handlers/liveness:** `New()` function ([016f07c][115])
- **api/handlers/liveness:** `Handler` struct ([133a5a8][116])
- **api/handlers/liveness:** package constants ([a0b8f71][117])
- **api/handlers/liveness:** `Response` struct ([9bc1341][118])

### Bug Fixes

- **sdk/api/response:** address linter complaints ([a9eed4e][119])

### Documentation

- **docker/buildx:** `gitpod` target ([11b8055][120])
- `liveness-probe` instruction ([fc5852c][121])
- **sdk/api/response:** `WriteJSON()` function synopsis ([7e25e0a][122])
- **sdk/api/response:** `WriteSuccessfulJSONRaw()` synopsis ([63d16c4][123])
- **swaggger:** add `GET` verb for `/healthz` ([5a0bb54][124])
- fix instruction to run mage's `build` target ([d35f513][125])
- **api/handlers/liveness:** `Initialize()` function ([a8993b7][126])
- **api/handlers/liveness:** `New()` function ([add5240][127])
- **api/handlers/liveness:** `Handler` struct ([06f7e41][128])
- **api/handlers/liveness:** package constants ([0e5f809][129])
- **api/handlers/liveness:** `Status` enum ([2ac0c5e][130])
- **api/handlers/liveness:** package synopsis ([efe22ac][131])
- **changelog:** updated changelog for v0.0.1 ([533f465][132])

### Refactors

- **api/handlers/liveness:** update `handler()` to write response json without
  adding additional fields ([985c2cf][133])
...
- **go-releaser:** do not sign archive ([b931100][136])
- **docker:** `gitpod` target ([006af3c][137])
- **just/bootstrap:** add `rust` toolchain ([6d9e725][138])
- **docker:** laxer package versioning in dockerfile ([9db2bb8][139])
- **docker:** fixed minor issues with `docker-bake.hcl` file ([747b4f4][140])
- **just/bootstrap:** add `bootstrap-os-pkgs` dependency to `bootstrap` target
  ([c397414][141])
- **just/go:** fix `mage` install in `_build-go` target ([7a6a5d9][142])
- **just/commit:** fix `bootstrap-pre-commit` hook installation
  ([495f420][143])
- **just/semver:** changed changelog commit message pattern ([9a5964e][144])

### CI

- **docker:** detect `TAG` ([5ca9bde][145])
- **go:** add `go-releaser` step ([74090a2][146])
- **release:** fix deprecated flags in `go-releaser` step ([0c641be][147])
- update min go version to `1.20` ([385d829][148])
- **go:** fixed arguments in `test` step ([2e45224][149])
- **go:** fixed arguments in `build` step ([55e6ae7][150])
- **release:** remove `unshallow` step ([2011e4f][151])
- **release:** update `setup-go` and `goreleaser-action` actions
  ([ea4cc92][152])

### Chore

- **gitpod:** source `gitpod` variables ([168e63f][153])
- **gitpod:** `rust` toolchain configuration ([e3e3d0d][154])
- **gitpod:** add `bootstrap` task ([d2ce4f1][155])
- **gitpod:** added more tools to the dockerfile ([79f5f6d][156])
- minor fix ([f9bc049][157])
- minor fix ([9ae11b2][158])
- **pre-commit:** ensure Justfile is identical to upstream in `just-fmt.sh`
  script ([ee99516][159])
- **gitpod:** replace `yarn` with `npm` in Dockerfile ([927e64b][160])
- change image in `.gitpod.yml` ([f494de7][161])
- fix `.gitpod.yml` ([8c3577e][162])

### v0.0.1 (2023-02-12)

#### Features

- **api:** init ([3974f95][163])
- **api/core:** init ([891fa92][164])
- **api/errors:** init ([dc9c0cc][165])
- **api/handlers:** init ([a9354fe][166])
- **api/middlewares:** init ([03877c6][167])
- **api/registry:** init ([c093b2a][168])
- **cmd/podinfo:** init ([a3c1ebf][169])
- **internal/cryptoutil:** init ([34a4597][170])
- **internal/files:** init ([4ac385c][171])
- **internal/golang-lru:** init ([f1264aa][172])
- **internal/locksutil:** init ([09e59d1][173])
- **internal/logger:** init ([e066d10][174])
- **internal/multierror:** init ([a39b7c2][175])
- **internal/pathmanager:** init ([489996c][176])
- **internal/permitpool:** init ([a29c5d7][177])
- **internal/prettyprint:** init ([2bc4ce1][178])
- **internal/primitives:** init ([1a67ad6][179])
- **internal/runtimex:** init ([76eb234][180])
- **internal/testutils:** init ([c188be8][181])
- **internal/urandom:** init ([58ed4ff][182])
- **internal/version:** init ([4a98993][183])
- **sdk/physical:** init ([f8d487e][184])
- **internal/backoff/constant:** init ([f70b48d][185])
- **internal/backoff/exponential:** init ([437e93c][186])
- **internal/cli/data:** init ([9d115ad][187])
- **internal/cli/decoder:** init ([5b380a7][188])
- **internal/cli/flagset:** init ([a233141][189])
- **internal/cli/value:** init ([aef98ca][190])
- **internal/golang-lru/simplelru:** init ([8196569][191])
- **internal/logger/slack:** init ([1e97608][192])
- **internal/radix-tree/immutable:** init ([5dbb2e9][193])
- **internal/radix-tree/mutable:** init ([fade8c6][194])
- **sdk/api/address:** init ([69918d7][195])
- **sdk/api/fastjson:** init ([e5403e6][196])
- **sdk/api/metrics:** init ([fd5e5e2][197])
- **sdk/api/port:** init ([979298e][198])
- **sdk/api/proto:** init ([3ddbd38][199])
- **sdk/api/response:** init ([76ab9c8][200])
- **sdk/api/route:** init ([2a7f6c7][201])
- **sdk/physical/access:** init ([829e8ef][202])
- **sdk/physical/cache:** init ([48e7940][203])
- **sdk/physical/chroot:** init ([5eb4b18][204])
- **sdk/physical/encoding:** init ([b1895bf][205])
- **sdk/physical/error-injector:** init ([fa52696][206])
- **sdk/physical/latency:** init ([7d4928f][207])
- **sdk/physical/retry:** init ([8660a4d][208])
- **cmd/podinfo/commands/server:** init ([540b954][209])
- **cmd/podinfo/commands/version:** init ([df8d8d1][210])
- **docker/release:** minimal `Dockerfile` for the binary ([c4cd6da][211])

#### Documentation

- init ([93e80f2][212])
- **build/go:** `Build` target synopsis ([a9e2bfb][213])
- **just/podinfo:** `run` target synopsis ([966607f][214])
- **just/podinfo:** `kill` target synopsis ([d4bb819][215])
- **just/go:** `build-go` target synopsis ([89c2bae][216])
- **just/go:** `clean-go` target synopsis ([7089f0b][217])
- **just/go:** `lint-go` target synopsis ([25b8479][218])
- **just/go:** `format-go` target synopsis ([1c62db8][219])
- **just/go:** `bootstrap-go` target synopsis ([e37bcd0][220])
- **just/go:** `_build` target synopsis ([50231ce][221])
- **just/go:** `_go` target synopsis ([f240c28][222])
- **just/go:** `_lint-go` target synopsis ([5ac43ba][223])
- **just/semver:** `bootstrap-semver` target synopsis ([92ec6b4][224])
- **just/markdown:** `_format-markdown` target synopsis ([2721074][225])
- **just/justfile:** `format-just` target synopsis ([78a7965][226])
- **just/json:** `format-json` target synopsis ([8c5778c][227])
- **just/json:** `_format-json` target synopsis ([6a417bd][228])
- **just/bash:** `lint-bash` target synopsis ([2e74c8d][229])
- **just/bash:** `format-bash` target synopsis ([b59a5d7][230])
- **just/bash:** `_lint-bash` target synopsis ([08b1ac6][231])
- **just/bash:** `_format-bash` target synopsis ([ef340bb][232])
- **just/misc:** `snapshot` target synopsis ([4026b9e][233])
- **just/misc:** `vscode-tasks` target synopsis ([deb5e1d][234])
- **just/semver:** `generate-changelog` target synopsis ([aa5683b][235])
- **just/semver:** `patch-release` target synopsis ([74afa35][236])
- **just/semver:** `minor-release` target synopsis ([2bde4d8][237])
- **just/semver:** `major-release` target synopsis ([03bb13d][238])
- **just/semver:** variable synopsis ([a5db8af][239])
- **just/commit:** `commit` target synopsis ([d02b807][240])
- **just/commit:** `bootstrap-pre-commit` target synopsis ([c367eae][241])
- **just/commit:** `_pre-commit` target synopsis ([6aee1b8][242])
- **just/git:** `git-add` target synopsis ([f84a9eb][243])
- **just/git:** `_git-delta` target synopsis ([3781d54][244])
- **just/git:** `_git-delta` target synopsis ([b8d961d][245])
- **just/bootstrap:** `_update-rust` target synopsis ([0d1588e][246])
- **just/bootstrap:** `_validate-rust` target synopsis ([b223255][247])
- **just/bootstrap:** `_install-nodejs-package` target synopsis
  ([58aabd6][248])
- **just/bootstrap:** `_bootstrap-nodejs` target synopsis ([00df92c][249])
- **just/bootstrap:** `_core-pkgs` target synopsis ([9a78d0a][250])
- **just/bootstrap:** `_install-os-package` target synopsis ([b817954][251])
- **just/bootstrap:** `_update-os-pkgs` target synopsis ([4b94227][252])
- **just/bootstrap:** `kary-comments` target synopsis ([f80992f][253])
- **just:** common variables ([9cc3843][254])
- **build/go/targets/test:** `Target` function synopsis ([7a17aad][255])
- **build/go/targets:** package synopsis ([40e593d][256])
- **build/go/targets/test:** package synopsis ([7e5375b][257])
- **build/go/targets/build:** package synopsis ([960062d][258])
- **build/go/git:** package synopsis ([2a1ffd4][259])
- **build/go/version:** package synopsis ([265da8c][260])
- **api:** synopsis ([295aad0][261])
- **sdk:** synopsis ([9f0d098][262])
- **api/core:** synopsis ([9ef7b34][263])
- **api/handlers:** synopsis ([b0e0874][264])
- **api/middlewares:** synopsis ([d3233c8][265])
- **api/registry:** synopsis ([e801ead][266])
- **internal/files:** synopsis ([a163f57][267])
- **internal/golang-lru:** synopsis ([d63c0a7][268])
- **internal/logger:** synopsis ([5d65330][269])
- **internal/permitpool:** synopsis ([41feade][270])
- **internal/prettyprint:** synopsis ([87c51ba][271])
- **internal/primitives:** synopsis ([8a083ac][272])
- **internal/runtimex:** synopsis ([dffbbdc][273])
- **internal/testutils:** synopsis ([3895ee7][274])
- **internal/urandom:** synopsis ([ab5c0b9][275])
- **sdk/api:** synopsis ([f657f44][276])
- **sdk/physical:** synopsis ([9706c76][277])
- **cmd/podinfo/commands:** synopsis ([108d9eb][278])
- **internal/cli/data:** synopsis ([3574a9c][279])
- **internal/cli/decoder:** synopsis ([a13ad40][280])
- **internal/cli/flagset:** synopsis ([0a9d0c1][281])
- **internal/logger/slack:** synopsis ([83a078c][282])
- **internal/radix-tree/immutable:** synopsis ([78abe82][283])
- **internal/radix-tree/mutable:** synopsis ([4e53b91][284])
- **sdk/api/address:** synopsis ([23ab44b][285])
- **sdk/api/fastjson:** synopsis ([2a7c790][286])
- **sdk/api/metrics:** synopsis ([c505728][287])
- **sdk/api/port:** synopsis ([1090e11][288])
- **sdk/api/proto:** synopsis ([197fad7][289])
- **sdk/api/response:** synopsis ([5cdbfab][290])
- **sdk/api/route:** synopsis ([6d23ed6][291])
- **sdk/physical/access:** synopsis ([cea7bee][292])
- **sdk/physical/cache:** synopsis ([13e7f7d][293])
- **sdk/physical/chroot:** synopsis ([4b31bb4][294])
- **sdk/physical/encoding:** synopsis ([49a1e33][295])
- **sdk/physical/error-injector:** synopsis ([70446b1][296])
- **sdk/physical/latency:** synopsis ([1f906c5][297])
- **sdk/physical/retry:** synopsis ([13983aa][298])
- **cmd/podinfo/commands/server:** synopsis ([942978f][299])
- **cmd/podinfo/commands/version:** synopsis ([26ea212][300])
- **docker-bake:** usage guide ([5344b78][301])
- **docker-bake:** `release` target synopsis ([e55beca][302])
- **docker-bake:** `default` group synopsis ([baf2270][303])
- **docker-bake:** `TAG` variable synopsis ([abe018f][304])
- **docker-bake:** `AMD64` variable synopsis ([7909900][305])
- **docker-bake:** `ARM64` variable synopsis ([750e36d][306])
- **docker-bake:** `REGISTRY_USERNAME` variable synopsis ([4c68a04][307])
- **docker-bake:** `REGISTRY_HOSTNAME` variable synopsis ([83e5534][308])
- **docker-bake:** `LOCAL` variable synopsis ([e238d0e][309])
- **github:** `programming_task` issue template ([dba5a78][310])
- **github:** `feature_request` issue template ([4124f12][311])
- **github:** `bug_report` issue template ([c7d8513][312])
- **github:** `api_endpoint_spec` issue template ([d60a2a9][313])

#### Refactors

- **mage:** remove old files ([eabe9ea][314])

#### Tests

- **api/core:** init ([0598dda][315])
- **internal/files:** init ([ffb9e6b][316])
- **internal/logger:** init ([1d6b435][317])
- **internal/primitives:** init ([b3ebabc][318])
- **internal/backoff/constant:** init ([c3255c2][319])
- **internal/backoff/exponential:** init ([588c83a][320])
- **internal/cli/decoder:** init ([1b3cfbe][321])
- **internal/cli/value:** init ([4aeaebb][322])
- **sdk/api/fastjson:** init ([01cd7be][323])

#### Build System

- **just/core:** aggregator targets ([3382f77][324])
- **just/podinfo:** `run` target implementation ([e262bfa][325])
- **just/podinfo:** `kill` target implementation ([40a0637][326])
- **just/go:** `build-go` target implementation ([d8670aa][327])
- **just/go:** `clean-go` target implementation ([8dc7e7c][328])
- **just/go:** `lint-go` target implementation ([14209fd][329])
- **just/go:** `format-go` target implementation ([0126826][330])
- **just/go:** `bootstrap-go` target implementation ([39b68ce][331])
- **just/go:** `_build` hidden target implementation ([47dc4e8][332])
- **just/go:** `_go` hidden target implementation ([26a247a][333])
- **just/go:** `_lint-go` hidden target implementation ([351a32a][334])
- **just/semver:** `bootstrap-semver` target implementation ([3ca58f4][335])
- **just/markdown:** `_format-markdown` hidden target implementation
  ([852e53e][336])
- **just/justfile:** `format-just` target implementation ([eb8efa2][337])
- **just/json:** `format-json` target implementation ([e540c34][338])
- **just/json:** `_format-json` hidden target implementation ([2754846][339])
- **just/bash:** `lint-bash` target implementation ([5cfd1f9][340])
- **just/bash:** `format-bash` target implementation ([05d97b0][341])
- **just/bash:** `_lint-bash` hidden target implementation ([2e56839][342])
- **just/bash:** `_format-bash` hidden target implementation ([2214242][343])
- **just/misc:** `snapshot` target implementation ([184f86e][344])
- **just/misc:** `vscode-tasks` target implementation ([8669e48][345])
- **just/semver:** `generate-changelog` target implementation ([d9813b6][346])
- **just/semver:** `patch-release` target implementation ([0ee99d8][347])
- **just/semver:** `minor-release` target implementation ([47c8d9d][348])
- **just/semver:** `major-release` target implementation ([4ca9c5c][349])
- **just/semver:** variable declaration ([fb9c78a][350])
- **just/commit:** `commit` target implementation ([f574bf3][351])
- **just/commit:** `bootstrap-pre-commit` target implementation
  ([1243472][352])
- **just/git:** `_pre-commit` hidden target implementation ([e5c5206][353])
- **just/git:** `git-add` target implementation ([b053a64][354])
- **just/git:** `git-fetch` target implementation ([28764fb][355])
- **just/git:** `_git-delta` hidden target implementation ([33b956f][356])
...
- **just/bootstrap:** `_update-os-pkgs` hidden target implementation
  ([7fb7d14][364])
- **just/bootstrap:** `kary-comments` target implementation ([8ffe083][365])
- **just:** common config ([86033e0][366])
- **go:** moved from `magefile.go` ([52e7886][367])
- **go/targets/test:** moved from `mage/test` ([84ef4a7][368])
- **go/targets/build:** moved from `mage/build` ([a07a063][369])
- **go/git:** moved from `mage/git` ([ae05d7a][370])
- **go/version:** moved from `internal/version` ([1906bdc][371])
- **docker-bake:** `release` target implementation ([778b6f7][372])
- **docker-bake:** `TAG` variable declaration ([dd58811][373])
- **docker-bake:** `AMD64` variable declaration ([763dcb7][374])
- **docker-bake:** `ARM64` variable declaration ([7feeae8][375])
- **docker-bake:** `REGISTRY_USERNAME` variable declaration ([c0493f8][376])
- **docker-bake:** `REGISTRY_HOSTNAME` variable declaration ([0cebd31][377])
- **docker-bake:** `LOCAL` variable declaration ([a89e0be][378])
- **docker/release:** added buildx installer/setup to the script
  ([607964a][379])
- **docker/release:** multi-arch builder script ([2d320e6][380])
- `go-releaser` config ([25bea21][381])
- **mage:** `magefile` init ([2e7af35][382])
- **test:** `test` mage targets ([84e27ca][383])
- **build:** `build` mage targets ([5471c34][384])
- **git:** `git` auxiliary library ([4908743][385])

#### CI

- **github:** `release` workflow ([fc1e8f4][386])
- **github:** `go` workflow ([299d59e][387])
- **github:** `docker` workflow ([4e9b676][388])

#### Chore

- **pre-commit:** `just-fmt` pre-commit hook ([57b16f2][389])
- **pre-commit:** `md-fmt` pre-commit hook ([8c4b6c4][390])
- **docs:** fix `markdown` file exception `.gitignore` ([b501fa4][391])
- **build:** local `.gitignore` ([755f5d2][392])
- **internal:** local `.gitignore` ([825e7c2][393])
- **sdk:** local `.gitignore` ([f55402b][394])
- **cmd:** local `.gitignore` ([6ff23fe][395])
- **api:** local `.gitignore` ([a160290][396])
- **docs:** local `.gitignore` ([fbfd5b7][397])
- **assets:** local `.gitignore` ([502e7a5][398])
- **fixtures:** local `.gitignore` ([7a098f4][399])
- simplify `.editorconfig` file ([b61d49c][400])
- fixed `.editorconfig` file ([a8db8f7][401])
- **pre-commit:** `go-mod-tidy` pre-commit hook ([713d5ab][402])
- **pre-commit:** `go-fmt` pre-commit hook ([2fbb351][403])
- **github:** `CODEOWNERS` file ([7d5618d][404])
- **vscode:** `tasks` configuration file ([8d9e1cd][405])
- **vscode:** `settings` configuration file ([3ec3faf][406])
- **vscode:** `launch` configuration file ([7ab2d30][407])
- **vscode:** `extensions` configuration file ([2f05faf][408])
- `gitpod` config ([6aeea05][409])
- go vendor dependency management with `tools.go` ([82fea78][410])
- `.env` file init ([24c7238][411])
- `pre-commit` config file ([3d8d786][412])
- **linter:** `cspell` golang dictionary ([7b20441][413])
- **linter:** `cspell` generic dictionary ([b95cfbe][414])
- **linter:** `cspell` config file ([63d43ce][415])
- **linter:** `golangci` config file ([87a9658][416])
- **linter:** `revive` config file ([40abb30][417])
- **linter:** `.markdownlintignore` file ([eb1bae8][418])
- `.versionrc` file ([bee9668][419])
- `.stignore` file ([5bb284d][420])
- `.editorconfig` file ([640d343][421])
- `.dockerignore` file ([aabfa50][422])
- `gitignore` file ([8c88606][423])
- **linter:** `commitlint` config ([4f34502][424])

[1]: https://github.com/da-moon/northern-labs-interview/compare/v0.6.2...v0.6.3
[2]:
